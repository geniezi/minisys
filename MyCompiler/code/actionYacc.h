...
reduceHead["nextlist"] = st[stackSize - 2 + 1]._map["nextlist"];
 ...
 reduceHead["itemlist"] = makeParam(st[stackSize - 2 + 2]._map["lexeme"],st[stackSize - 2 + 1]._map["type"],atoi(st[stackSize - 2 + 1]._map["width"].c_str()));
	...
	case 22 ://param->type_spec id [ num ] 
...
enter(st[stackSize - 2 + 2]._map["lexeme"],st[stackSize - 2 + 1]._map["type"],atoi(st[stackSize - 2 + 1]._map["width"].c_str()));
	...
	case 24 ://var_decl->type_spec id = expr 
	...
	case 25 ://var_decl->type_spec id [ num ] 
 ...
 reduceHead["type"] = "float";
	...
	case 33 ://expr_stmt->id [ expr ] = expr 
	...
	case 50 ://expr->load_mem ( expr ) 
		reduceHead["place"] = newtemp("int");
		emit("load",st[stackSize - 4 + 3]._map["place"],"",reduceHead["place"]);
	
	return pair<unsigned int, string>(4,"expr");

	case 51 ://arg_list->arg_list , expr 
 ...
 paramStack.push(st[stackSize - 1 + 1]._map["place"]);
	...
	case 54 ://if_stmt->if BlockLeader ( logic_expr ) M stmt 
	...
	case 55 ://if_stmt->if BlockLeader ( logic_expr ) M stmt N else M stmt 
	...
	case 56 ://while_stmt->while BlockLeader M ( logic_expr ) M stmt 
	...
	case 57 ://logic_expr->logic_expr && M logic_expr 
	...
	case 61 ://logic_expr->expr rel expr 
	...
	case 63 ://logic_expr->true 
				reduceHead["truelist"] = makelist(nextInstr);
				emit("j","","","_");
			
	return pair<unsigned int, string>(1,"logic_expr");

	case 64 ://logic_expr->false 
...
string getProduction(unsigned int index) {
	switch(index) {
		...
		case 22 :return "param->type_spec id [ num ] ";
		case 23 :return "var_decl->type_spec id ";
		case 24 :return "var_decl->type_spec id = expr ";
		case 25 :return "var_decl->type_spec id [ num ] ";
		case 26 :return "type_spec->int ";
		case 27 :return "type_spec->double ";
		case 28 :return "type_spec->void ";
		case 29 :return "type_spec->char ";
		case 30 :return "type_spec->bool ";
		case 31 :return "type_spec->float ";
		case 32 :return "expr_stmt->id = expr ";
		case 33 :return "expr_stmt->id [ expr ] = expr ";
		...
		case 46 :return "expr->id ( arg_list ) ";
		case 47 :return "expr->num ";
		case 48 :return "expr->- expr ";
		case 49 :return "expr->id [ expr ] ";
		case 50 :return "expr->load_mem ( expr ) ";
		case 51 :return "arg_list->arg_list , expr ";
		case 52 :return "arg_list->expr ";
		case 53 :return "arg_list->";
		case 54 :return "if_stmt->if BlockLeader ( logic_expr ) M stmt ";
		case 55 :return "if_stmt->if BlockLeader ( logic_expr ) M stmt N else M stmt ";
		case 56 :return "while_stmt->while BlockLeader M ( logic_expr ) M stmt ";
		case 57 :return "logic_expr->logic_expr && M logic_expr ";
		case 58 :return "logic_expr->logic_expr || M logic_expr ";
		case 59 :return "logic_expr->! logic_expr ";
		case 60 :return "logic_expr->( logic_expr ) ";
		case 61 :return "logic_expr->expr rel expr ";
		case 62 :return "logic_expr->expr ";
		case 63 :return "logic_expr->true ";
		case 64 :return "logic_expr->false ";
		case 65 :return "M->";
		case 66 :return "N->";
		case 67 :return "BlockLeader->";
		case 68 :return "rel->< ";
		case 69 :return "rel->> ";
		case 70 :return "rel-><= ";
		case 71 :return "rel-><= ";
