...
void initTable(map<unsigned int, map<string, TableItem> >& _parseTable) {
	...
	tran.insert(make_pair("set_mem", TableItem(1,13)));
	tran.insert(make_pair("include", TableItem(1,14)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,15)));
	tran.insert(make_pair("type_spec", TableItem(3,16)));
	tran.insert(make_pair("id", TableItem(1,17)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	tran.insert(make_pair("char", TableItem(1,21)));
	tran.insert(make_pair("bool", TableItem(1,22)));
	tran.insert(make_pair("float", TableItem(1,23)));
	tran.insert(make_pair("if", TableItem(1,24)));
	tran.insert(make_pair("while", TableItem(1,25)));
	...
	// state 2
	tran.insert(make_pair("M", TableItem(3,26)));
	...
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	// state 5
	tran.insert(make_pair("stmts", TableItem(3,27)));
	tran.insert(make_pair("stmt", TableItem(3,28)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	tran.insert(make_pair("if_stmt", TableItem(3,32)));
	tran.insert(make_pair("while_stmt", TableItem(3,33)));
	tran.insert(make_pair("var_decl", TableItem(3,34)));
	tran.insert(make_pair("static", TableItem(1,35)));
	tran.insert(make_pair("expr_stmt", TableItem(3,36)));
	tran.insert(make_pair("return", TableItem(1,37)));
	tran.insert(make_pair("set_mem", TableItem(1,38)));
	tran.insert(make_pair("include", TableItem(1,39)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,40)));
	tran.insert(make_pair("type_spec", TableItem(3,41)));
	tran.insert(make_pair("id", TableItem(1,17)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	tran.insert(make_pair("bool", TableItem(1,22)));
	tran.insert(make_pair("float", TableItem(1,23)));
	tran.insert(make_pair("if", TableItem(1,42)));
	tran.insert(make_pair("while", TableItem(1,43)));
	...
	// state 9
	tran.insert(make_pair(";", TableItem(1,44)));
	_parseTable.insert(make_pair(9,tran));
	tran.clear();


	// state 10
	tran.insert(make_pair("var_decl", TableItem(3,45)));
	tran.insert(make_pair("type_spec", TableItem(3,46)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	tran.insert(make_pair("char", TableItem(1,21)));
	...
	// state 11
	tran.insert(make_pair(";", TableItem(1,47)));
	...
	tran.insert(make_pair("expr", TableItem(3,49)));
	tran.insert(make_pair("(", TableItem(1,50)));
	tran.insert(make_pair("id", TableItem(1,51)));
	tran.insert(make_pair("num", TableItem(1,52)));
	tran.insert(make_pair("load_mem", TableItem(1,53)));
	_parseTable.insert(make_pair(12,tran));
	tran.clear();


	// state 13
	tran.insert(make_pair("(", TableItem(1,54)));
	...
	// state 16
	tran.insert(make_pair("id", TableItem(1,58)));
	...
	// state 24
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,61)));
	...
	// state 25
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair("static", TableItem(2,67)));
	tran.insert(make_pair("return", TableItem(2,67)));
	tran.insert(make_pair("set_mem", TableItem(2,67)));
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("include", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,62)));
	tran.insert(make_pair("id", TableItem(2,67)));
	tran.insert(make_pair("int", TableItem(2,67)));
	tran.insert(make_pair("double", TableItem(2,67)));
	tran.insert(make_pair("void", TableItem(2,67)));
	tran.insert(make_pair("char", TableItem(2,67)));
	tran.insert(make_pair("bool", TableItem(2,67)));
	tran.insert(make_pair("float", TableItem(2,67)));
	tran.insert(make_pair("if", TableItem(2,67)));
	tran.insert(make_pair("while", TableItem(2,67)));
	tran.insert(make_pair("$", TableItem(2,67)));
	...
	// state 26
	tran.insert(make_pair("stmt", TableItem(3,63)));
	tran.insert(make_pair("includestmt", TableItem(3,4)));
	tran.insert(make_pair("{", TableItem(1,5)));
	tran.insert(make_pair("fun_define", TableItem(3,6)));
	tran.insert(make_pair("if_stmt", TableItem(3,7)));
	...
	// state 30
	tran.insert(make_pair("stmts", TableItem(3,66)));
	tran.insert(make_pair("stmt", TableItem(3,28)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	...
	// state 35
	tran.insert(make_pair("var_decl", TableItem(3,68)));
	tran.insert(make_pair("type_spec", TableItem(3,46)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	// state 37
	tran.insert(make_pair("-", TableItem(1,48)));
	tran.insert(make_pair("expr", TableItem(3,70)));
	tran.insert(make_pair("(", TableItem(1,50)));
	tran.insert(make_pair("id", TableItem(1,51)));
	tran.insert(make_pair("num", TableItem(1,52)));
	tran.insert(make_pair("load_mem", TableItem(1,53)));
	...
	// state 40
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,74)));
	_parseTable.insert(make_pair(40,tran));
	tran.clear();


	// state 41
	tran.insert(make_pair("id", TableItem(1,75)));
	...
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("include", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,77)));
	tran.insert(make_pair("id", TableItem(2,67)));
	tran.insert(make_pair("int", TableItem(2,67)));
	tran.insert(make_pair("double", TableItem(2,67)));
	tran.insert(make_pair("void", TableItem(2,67)));
	...
	// state 46
	tran.insert(make_pair("id", TableItem(1,79)));
	...
	// state 48
	tran.insert(make_pair("-", TableItem(1,48)));
	tran.insert(make_pair("expr", TableItem(3,80)));
	tran.insert(make_pair("(", TableItem(1,50)));
	tran.insert(make_pair("id", TableItem(1,51)));
	tran.insert(make_pair("num", TableItem(1,52)));
	tran.insert(make_pair("load_mem", TableItem(1,53)));
	...
	tran.insert(make_pair("expr", TableItem(3,93)));
	tran.insert(make_pair("(", TableItem(1,94)));
	tran.insert(make_pair("id", TableItem(1,95)));
	tran.insert(make_pair("num", TableItem(1,96)));
	tran.insert(make_pair("load_mem", TableItem(1,97)));
	...
	// state 55
	tran.insert(make_pair("filename", TableItem(1,107)));
	_parseTable.insert(make_pair(55,tran));
	tran.clear();


	// state 56
	tran.insert(make_pair("filename", TableItem(1,108)));
	...
	// state 59
	tran.insert(make_pair("-", TableItem(1,48)));
	tran.insert(make_pair("expr", TableItem(3,113)));
	tran.insert(make_pair("(", TableItem(1,50)));
	tran.insert(make_pair("id", TableItem(1,51)));
	tran.insert(make_pair("num", TableItem(1,52)));
	tran.insert(make_pair("load_mem", TableItem(1,53)));
	...
	tran.insert(make_pair("id", TableItem(1,117)));
	tran.insert(make_pair("num", TableItem(1,118)));
	tran.insert(make_pair("load_mem", TableItem(1,119)));
	...
	// state 62
	tran.insert(make_pair("M", TableItem(3,121)));
	tran.insert(make_pair("(", TableItem(2,65)));
	...
	// state 64
	tran.insert(make_pair("stmt", TableItem(3,122)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	tran.insert(make_pair("if_stmt", TableItem(3,32)));
	...
	// state 68
	tran.insert(make_pair(";", TableItem(1,124)));
	...
	// state 72
	tran.insert(make_pair("filename", TableItem(1,127)));
	_parseTable.insert(make_pair(72,tran));
	tran.clear();


	// state 73
	tran.insert(make_pair("filename", TableItem(1,128)));
	_parseTable.insert(make_pair(73,tran));
	tran.clear();


	// state 74
	tran.insert(make_pair("{", TableItem(1,129)));
	...
	// state 77
	tran.insert(make_pair("M", TableItem(3,132)));
	tran.insert(make_pair("(", TableItem(2,65)));
	...
	// state 81
	tran.insert(make_pair("-", TableItem(1,48)));
	tran.insert(make_pair("expr", TableItem(3,133)));
	tran.insert(make_pair("(", TableItem(1,50)));
	tran.insert(make_pair("id", TableItem(1,51)));
	tran.insert(make_pair("num", TableItem(1,52)));
	tran.insert(make_pair("load_mem", TableItem(1,53)));
	...
	// state 94
	tran.insert(make_pair("-", TableItem(1,92)));
	tran.insert(make_pair("expr", TableItem(3,155)));
	tran.insert(make_pair("(", TableItem(1,94)));
	tran.insert(make_pair("id", TableItem(1,95)));
	tran.insert(make_pair("num", TableItem(1,96)));
	tran.insert(make_pair("load_mem", TableItem(1,97)));
	...
	tran.insert(make_pair(")", TableItem(2,53)));
	tran.insert(make_pair("id", TableItem(1,162)));
	tran.insert(make_pair("num", TableItem(1,163)));
	tran.insert(make_pair("arg_list", TableItem(3,164)));
	tran.insert(make_pair("load_mem", TableItem(1,165)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,189)));
	tran.insert(make_pair("param_list", TableItem(3,190)));
	tran.insert(make_pair("param", TableItem(3,191)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	tran.insert(make_pair("char", TableItem(1,21)));
	...
	// state 112
	tran.insert(make_pair("num", TableItem(1,192)));
	...
	// state 114
	tran.insert(make_pair("-", TableItem(1,114)));
	tran.insert(make_pair("expr", TableItem(3,193)));
	tran.insert(make_pair("(", TableItem(1,116)));
	tran.insert(make_pair("id", TableItem(1,117)));
	tran.insert(make_pair("num", TableItem(1,118)));
	tran.insert(make_pair("load_mem", TableItem(1,119)));
	...
	// state 116
	tran.insert(make_pair("-", TableItem(1,92)));
	tran.insert(make_pair("expr", TableItem(3,205)));
	tran.insert(make_pair("(", TableItem(1,94)));
	tran.insert(make_pair("id", TableItem(1,95)));
	tran.insert(make_pair("num", TableItem(1,96)));
	tran.insert(make_pair("load_mem", TableItem(1,97)));
	...
	tran.insert(make_pair("id", TableItem(1,213)));
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,216)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	// state 129
	tran.insert(make_pair("stmts", TableItem(3,223)));
	tran.insert(make_pair("stmt", TableItem(3,28)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,189)));
	tran.insert(make_pair("param_list", TableItem(3,225)));
	tran.insert(make_pair("param", TableItem(3,191)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,226)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("id", TableItem(1,162)));
	tran.insert(make_pair("num", TableItem(1,163)));
	tran.insert(make_pair("arg_list", TableItem(3,239)));
	tran.insert(make_pair("load_mem", TableItem(1,165)));
	...
	// state 161
	tran.insert(make_pair("-", TableItem(1,92)));
	tran.insert(make_pair("expr", TableItem(3,253)));
	tran.insert(make_pair("(", TableItem(1,94)));
	tran.insert(make_pair("id", TableItem(1,95)));
	tran.insert(make_pair("num", TableItem(1,96)));
	tran.insert(make_pair("load_mem", TableItem(1,97)));
	...
	tran.insert(make_pair("id", TableItem(1,162)));
	tran.insert(make_pair("num", TableItem(1,163)));
	tran.insert(make_pair("arg_list", TableItem(3,273)));
	tran.insert(make_pair("load_mem", TableItem(1,165)));
	...
	// state 189
	tran.insert(make_pair("id", TableItem(1,277)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,298)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair(")", TableItem(2,62)));
	tran.insert(make_pair("rel", TableItem(3,314)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,316)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,323)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,328)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("/", TableItem(1,152)));
	tran.insert(make_pair("%", TableItem(1,153)));
	tran.insert(make_pair(")", TableItem(1,347)));
	...
	// state 273
	tran.insert(make_pair(",", TableItem(1,256)));
	tran.insert(make_pair(")", TableItem(1,348)));
	...
	// state 278
	tran.insert(make_pair("type_spec", TableItem(3,189)));
	tran.insert(make_pair("param", TableItem(3,352)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	tran.insert(make_pair("char", TableItem(1,21)));
	...
	tran.insert(make_pair("load_mem", TableItem(2,68)));
	...
	tran.insert(make_pair("id", TableItem(1,371)));
	tran.insert(make_pair("num", TableItem(1,372)));
	tran.insert(make_pair("load_mem", TableItem(1,373)));
	...
	tran.insert(make_pair("id", TableItem(1,162)));
	tran.insert(make_pair("num", TableItem(1,163)));
	tran.insert(make_pair("arg_list", TableItem(3,376)));
	tran.insert(make_pair("load_mem", TableItem(1,165)));
	...
	tran.insert(make_pair("-", TableItem(2,65)));
	tran.insert(make_pair("!", TableItem(2,65)));
	tran.insert(make_pair("M", TableItem(3,379)));
	tran.insert(make_pair("(", TableItem(2,65)));
	tran.insert(make_pair("id", TableItem(2,65)));
	tran.insert(make_pair("num", TableItem(2,65)));
	tran.insert(make_pair("load_mem", TableItem(2,65)));
	tran.insert(make_pair("true", TableItem(2,65)));
	tran.insert(make_pair("false", TableItem(2,65)));
	...
	tran.insert(make_pair("-", TableItem(2,65)));
	tran.insert(make_pair("!", TableItem(2,65)));
	tran.insert(make_pair("M", TableItem(3,380)));
	tran.insert(make_pair("(", TableItem(2,65)));
	tran.insert(make_pair("id", TableItem(2,65)));
	tran.insert(make_pair("num", TableItem(2,65)));
	tran.insert(make_pair("load_mem", TableItem(2,65)));
	...
	// state 327
	tran.insert(make_pair("M", TableItem(3,384)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	// state 351
	tran.insert(make_pair("num", TableItem(1,390)));
	...
	// state 368
	tran.insert(make_pair("-", TableItem(1,368)));
	tran.insert(make_pair("expr", TableItem(3,391)));
	tran.insert(make_pair("(", TableItem(1,370)));
	tran.insert(make_pair("id", TableItem(1,371)));
	tran.insert(make_pair("num", TableItem(1,372)));
	tran.insert(make_pair("load_mem", TableItem(1,373)));
	...
	// state 370
	tran.insert(make_pair("-", TableItem(1,92)));
	tran.insert(make_pair("expr", TableItem(3,402)));
	tran.insert(make_pair("(", TableItem(1,94)));
	tran.insert(make_pair("id", TableItem(1,95)));
	tran.insert(make_pair("num", TableItem(1,96)));
	tran.insert(make_pair("load_mem", TableItem(1,97)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,409)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,410)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	// state 381
	tran.insert(make_pair("stmt", TableItem(3,411)));
	tran.insert(make_pair("includestmt", TableItem(3,412)));
	tran.insert(make_pair("{", TableItem(1,413)));
	tran.insert(make_pair("fun_define", TableItem(3,414)));
	tran.insert(make_pair("if_stmt", TableItem(3,415)));
	tran.insert(make_pair("while_stmt", TableItem(3,416)));
	tran.insert(make_pair("var_decl", TableItem(3,417)));
	tran.insert(make_pair("static", TableItem(1,418)));
	tran.insert(make_pair("expr_stmt", TableItem(3,419)));
	tran.insert(make_pair("return", TableItem(1,420)));
	tran.insert(make_pair("set_mem", TableItem(1,421)));
	tran.insert(make_pair("include", TableItem(1,422)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,423)));
	tran.insert(make_pair("type_spec", TableItem(3,424)));
	tran.insert(make_pair("id", TableItem(1,17)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	tran.insert(make_pair("bool", TableItem(1,22)));
	tran.insert(make_pair("float", TableItem(1,23)));
	tran.insert(make_pair("if", TableItem(1,425)));
	tran.insert(make_pair("while", TableItem(1,426)));
	_parseTable.insert(make_pair(381,tran));
	tran.clear();


	// state 382
	tran.insert(make_pair("M", TableItem(3,427)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	// state 383
	tran.insert(make_pair(";", TableItem(1,428)));
	_parseTable.insert(make_pair(383,tran));
	tran.clear();


	// state 384
	tran.insert(make_pair("stmt", TableItem(3,429)));
	tran.insert(make_pair("includestmt", TableItem(3,430)));
	tran.insert(make_pair("{", TableItem(1,431)));
	tran.insert(make_pair("fun_define", TableItem(3,432)));
	tran.insert(make_pair("if_stmt", TableItem(3,433)));
	tran.insert(make_pair("while_stmt", TableItem(3,434)));
	tran.insert(make_pair("var_decl", TableItem(3,435)));
	tran.insert(make_pair("static", TableItem(1,436)));
	tran.insert(make_pair("expr_stmt", TableItem(3,437)));
	tran.insert(make_pair("return", TableItem(1,438)));
	tran.insert(make_pair("set_mem", TableItem(1,439)));
	tran.insert(make_pair("include", TableItem(1,440)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,441)));
	tran.insert(make_pair("type_spec", TableItem(3,442)));
	tran.insert(make_pair("id", TableItem(1,17)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	tran.insert(make_pair("bool", TableItem(1,22)));
	tran.insert(make_pair("float", TableItem(1,23)));
	tran.insert(make_pair("if", TableItem(1,443)));
	tran.insert(make_pair("while", TableItem(1,444)));
	_parseTable.insert(make_pair(384,tran));
	tran.clear();


	// state 385
	tran.insert(make_pair("M", TableItem(3,445)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	// state 390
	tran.insert(make_pair("]", TableItem(1,446)));
	...
	tran.insert(make_pair("id", TableItem(1,162)));
	tran.insert(make_pair("num", TableItem(1,163)));
	tran.insert(make_pair("arg_list", TableItem(3,458)));
	tran.insert(make_pair("load_mem", TableItem(1,165)));
	...
	// state 411
	tran.insert(make_pair("else", TableItem(2,66)));
	...
	tran.insert(make_pair("set_mem", TableItem(2,54)));
	...
	tran.insert(make_pair("N", TableItem(3,461)));
	...
	// state 413
	tran.insert(make_pair("stmts", TableItem(3,462)));
	tran.insert(make_pair("stmt", TableItem(3,28)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	...
	// state 418
	tran.insert(make_pair("var_decl", TableItem(3,464)));
	tran.insert(make_pair("type_spec", TableItem(3,46)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	// state 422
	tran.insert(make_pair("<", TableItem(1,468)));
	...
	// state 423
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,470)));
	_parseTable.insert(make_pair(423,tran));
	tran.clear();


	// state 424
	tran.insert(make_pair("id", TableItem(1,471)));
	...
	// state 425
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,472)));
	...
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("include", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,473)));
	tran.insert(make_pair("id", TableItem(2,67)));
	tran.insert(make_pair("int", TableItem(2,67)));
	tran.insert(make_pair("double", TableItem(2,67)));
	tran.insert(make_pair("void", TableItem(2,67)));
	...
	// state 427
	tran.insert(make_pair("stmt", TableItem(3,474)));
	tran.insert(make_pair("includestmt", TableItem(3,4)));
	tran.insert(make_pair("{", TableItem(1,5)));
	tran.insert(make_pair("fun_define", TableItem(3,6)));
	tran.insert(make_pair("if_stmt", TableItem(3,7)));
	...
	tran.insert(make_pair("float", TableItem(2,54)));
	tran.insert(make_pair("if", TableItem(2,54)));
	tran.insert(make_pair("N", TableItem(3,475)));
	tran.insert(make_pair("while", TableItem(2,54)));
	...
	// state 431
	tran.insert(make_pair("stmts", TableItem(3,476)));
	tran.insert(make_pair("stmt", TableItem(3,28)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	...
	// state 435
	tran.insert(make_pair(";", TableItem(1,477)));
	_parseTable.insert(make_pair(435,tran));
	tran.clear();


	// state 436
	tran.insert(make_pair("var_decl", TableItem(3,478)));
	tran.insert(make_pair("type_spec", TableItem(3,46)));
	tran.insert(make_pair("int", TableItem(1,18)));
	tran.insert(make_pair("double", TableItem(1,19)));
	tran.insert(make_pair("void", TableItem(1,20)));
	...
	// state 438
	tran.insert(make_pair("-", TableItem(1,48)));
	tran.insert(make_pair("expr", TableItem(3,480)));
	tran.insert(make_pair("(", TableItem(1,50)));
	tran.insert(make_pair("id", TableItem(1,51)));
	tran.insert(make_pair("num", TableItem(1,52)));
	tran.insert(make_pair("load_mem", TableItem(1,53)));
	...
	// state 441
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,484)));
	_parseTable.insert(make_pair(441,tran));
	tran.clear();


	// state 442
	tran.insert(make_pair("id", TableItem(1,485)));
	...
	// state 443
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,486)));
	...
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("include", TableItem(2,67)));
	tran.insert(make_pair("BlockLeader", TableItem(3,487)));
	tran.insert(make_pair("id", TableItem(2,67)));
	tran.insert(make_pair("int", TableItem(2,67)));
	tran.insert(make_pair("double", TableItem(2,67)));
	tran.insert(make_pair("void", TableItem(2,67)));
	...
	// state 445
	tran.insert(make_pair("stmt", TableItem(3,488)));
	tran.insert(make_pair("includestmt", TableItem(3,29)));
	tran.insert(make_pair("{", TableItem(1,30)));
	tran.insert(make_pair("fun_define", TableItem(3,31)));
	tran.insert(make_pair("if_stmt", TableItem(3,32)));
	...
	// state 486
	tran.insert(make_pair("(", TableItem(1,512)));
	_parseTable.insert(make_pair(486,tran));
	tran.clear();


	// state 487
	tran.insert(make_pair("M", TableItem(3,513)));
	tran.insert(make_pair("(", TableItem(2,65)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,521)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,530)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("||", TableItem(1,320)));
	tran.insert(make_pair("&&", TableItem(1,321)));
	tran.insert(make_pair(")", TableItem(1,536)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,537)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	tran.insert(make_pair("num", TableItem(1,214)));
	tran.insert(make_pair("load_mem", TableItem(1,215)));
	tran.insert(make_pair("logic_expr", TableItem(3,543)));
	tran.insert(make_pair("true", TableItem(1,217)));
	tran.insert(make_pair("false", TableItem(1,218)));
	...
	// state 536
	tran.insert(make_pair("M", TableItem(3,545)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	// state 542
	tran.insert(make_pair("M", TableItem(3,548)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	tran.insert(make_pair("||", TableItem(1,320)));
	tran.insert(make_pair("&&", TableItem(1,321)));
	tran.insert(make_pair(")", TableItem(1,549)));
	...
	// state 545
	tran.insert(make_pair("stmt", TableItem(3,551)));
	tran.insert(make_pair("includestmt", TableItem(3,412)));
	tran.insert(make_pair("{", TableItem(1,413)));
	tran.insert(make_pair("fun_define", TableItem(3,414)));
	tran.insert(make_pair("if_stmt", TableItem(3,415)));
	...
	// state 549
	tran.insert(make_pair("M", TableItem(3,555)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	tran.insert(make_pair("float", TableItem(2,54)));
	tran.insert(make_pair("if", TableItem(2,54)));
	tran.insert(make_pair("N", TableItem(3,556)));
	tran.insert(make_pair("while", TableItem(2,54)));
	tran.insert(make_pair("$", TableItem(2,54)));
	...
	// state 552
	tran.insert(make_pair("stmt", TableItem(3,557)));
	tran.insert(make_pair("includestmt", TableItem(3,412)));
	tran.insert(make_pair("{", TableItem(1,413)));
	tran.insert(make_pair("fun_define", TableItem(3,414)));
	tran.insert(make_pair("if_stmt", TableItem(3,415)));
	...
	tran.insert(make_pair("float", TableItem(2,54)));
	tran.insert(make_pair("if", TableItem(2,54)));
	tran.insert(make_pair("N", TableItem(3,558)));
	tran.insert(make_pair("while", TableItem(2,54)));
	...
	// state 555
	tran.insert(make_pair("stmt", TableItem(3,559)));
	tran.insert(make_pair("includestmt", TableItem(3,430)));
	tran.insert(make_pair("{", TableItem(1,431)));
	tran.insert(make_pair("fun_define", TableItem(3,432)));
	tran.insert(make_pair("if_stmt", TableItem(3,433)));
	...
	// state 556
	tran.insert(make_pair("else", TableItem(1,560)));
	...
	// state 558
	tran.insert(make_pair("else", TableItem(1,561)));
	...
	// state 561
	tran.insert(make_pair("M", TableItem(3,563)));
	tran.insert(make_pair("{", TableItem(2,65)));
	tran.insert(make_pair("static", TableItem(2,65)));
	tran.insert(make_pair("return", TableItem(2,65)));
	tran.insert(make_pair("set_mem", TableItem(2,65)));
	...
	// state 563
	tran.insert(make_pair("stmt", TableItem(3,565)));
	tran.insert(make_pair("includestmt", TableItem(3,430)));
	tran.insert(make_pair("{", TableItem(1,431)));
	tran.insert(make_pair("fun_define", TableItem(3,432)));
	tran.insert(make_pair("if_stmt", TableItem(3,433)));
