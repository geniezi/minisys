...
void initTable(map<unsigned int, map<string, TableItem> >& _parseTable) {
	...
	tran.insert(make_pair("expr", TableItem(3,52)));
	tran.insert(make_pair("(", TableItem(1,53)));
	tran.insert(make_pair("id", TableItem(1,54)));
	tran.insert(make_pair("num", TableItem(1,55)));
	tran.insert(make_pair("load_mem", TableItem(1,56)));
	...
	tran.insert(make_pair("BlockLeader", TableItem(3,60)));
	_parseTable.insert(make_pair(16,tran));
	tran.clear();


	// state 17
	tran.insert(make_pair("id", TableItem(1,61)));
	...
	// state 25
	tran.insert(make_pair("(", TableItem(1,64)));
	_parseTable.insert(make_pair(25,tran));
	tran.clear();


	// state 26
	tran.insert(make_pair("M", TableItem(3,65)));
	tran.insert(make_pair("(", TableItem(2,67)));
	...
	// state 27
	tran.insert(make_pair("stmt", TableItem(3,66)));
	tran.insert(make_pair("includestmt", TableItem(3,4)));
	tran.insert(make_pair("{", TableItem(1,5)));
	tran.insert(make_pair("fun_define", TableItem(3,6)));
	tran.insert(make_pair("if_stmt", TableItem(3,7)));
	...
	// state 28
	tran.insert(make_pair("M", TableItem(3,67)));
	tran.insert(make_pair("{", TableItem(2,67)));
	...
	// state 31
	tran.insert(make_pair("stmts", TableItem(3,69)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 35
	tran.insert(make_pair(";", TableItem(1,70)));
	...
	// state 37
	tran.insert(make_pair("var_decl", TableItem(3,71)));
	tran.insert(make_pair("type_spec", TableItem(3,48)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("expr", TableItem(3,74)));
	tran.insert(make_pair("(", TableItem(1,53)));
	tran.insert(make_pair("id", TableItem(1,54)));
	tran.insert(make_pair("num", TableItem(1,55)));
	tran.insert(make_pair("load_mem", TableItem(1,56)));
	...
	// state 45
	tran.insert(make_pair("M", TableItem(3,81)));
	tran.insert(make_pair("(", TableItem(2,67)));
	...
	// state 48
	tran.insert(make_pair("id", TableItem(1,83)));
	...
	// state 50
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,84)));
	tran.insert(make_pair("(", TableItem(1,53)));
	tran.insert(make_pair("id", TableItem(1,54)));
	tran.insert(make_pair("num", TableItem(1,55)));
	tran.insert(make_pair("load_mem", TableItem(1,56)));
	...
	tran.insert(make_pair("expr", TableItem(3,97)));
	tran.insert(make_pair("(", TableItem(1,98)));
	tran.insert(make_pair("id", TableItem(1,99)));
	tran.insert(make_pair("num", TableItem(1,100)));
	tran.insert(make_pair("load_mem", TableItem(1,101)));
	...
	tran.insert(make_pair("expr", TableItem(3,106)));
	tran.insert(make_pair("(", TableItem(1,107)));
	tran.insert(make_pair("id", TableItem(1,108)));
	tran.insert(make_pair("num", TableItem(1,109)));
	tran.insert(make_pair("load_mem", TableItem(1,110)));
	_parseTable.insert(make_pair(57,tran));
	tran.clear();


	// state 58
	tran.insert(make_pair("filename", TableItem(1,111)));
	...
	tran.insert(make_pair("id", TableItem(1,121)));
	tran.insert(make_pair("num", TableItem(1,122)));
	tran.insert(make_pair("load_mem", TableItem(1,123)));
	...
	tran.insert(make_pair("id", TableItem(1,128)));
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,131)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	// state 67
	tran.insert(make_pair("stmt", TableItem(3,135)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	tran.insert(make_pair("if_stmt", TableItem(3,33)));
	...
	// state 76
	tran.insert(make_pair("filename", TableItem(1,140)));
	_parseTable.insert(make_pair(76,tran));
	tran.clear();


	// state 77
	tran.insert(make_pair("filename", TableItem(1,141)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,144)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	// state 96
	tran.insert(make_pair("-", TableItem(1,96)));
	tran.insert(make_pair("expr", TableItem(3,156)));
	tran.insert(make_pair("(", TableItem(1,98)));
	tran.insert(make_pair("id", TableItem(1,99)));
	tran.insert(make_pair("num", TableItem(1,100)));
	tran.insert(make_pair("load_mem", TableItem(1,101)));
	...
	tran.insert(make_pair(")", TableItem(2,55)));
	tran.insert(make_pair("id", TableItem(1,175)));
	tran.insert(make_pair("num", TableItem(1,176)));
	tran.insert(make_pair("arg_list", TableItem(3,177)));
	tran.insert(make_pair("load_mem", TableItem(1,178)));
	...
	// state 105
	tran.insert(make_pair("-", TableItem(1,105)));
	tran.insert(make_pair("expr", TableItem(3,181)));
	tran.insert(make_pair("(", TableItem(1,107)));
	tran.insert(make_pair("id", TableItem(1,108)));
	tran.insert(make_pair("num", TableItem(1,109)));
	tran.insert(make_pair("load_mem", TableItem(1,110)));
	...
	// state 113
	tran.insert(make_pair("stmts", TableItem(3,199)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 114
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,200)));
	tran.insert(make_pair("(", TableItem(1,53)));
	tran.insert(make_pair("id", TableItem(1,54)));
	tran.insert(make_pair("num", TableItem(1,55)));
	tran.insert(make_pair("load_mem", TableItem(1,56)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,202)));
	tran.insert(make_pair("param_list", TableItem(3,203)));
	tran.insert(make_pair("param", TableItem(3,204)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	tran.insert(make_pair("char", TableItem(1,22)));
	...
	// state 116
	tran.insert(make_pair("num", TableItem(1,205)));
	...
	// state 120
	tran.insert(make_pair("-", TableItem(1,96)));
	tran.insert(make_pair("expr", TableItem(3,218)));
	tran.insert(make_pair("(", TableItem(1,98)));
	tran.insert(make_pair("id", TableItem(1,99)));
	tran.insert(make_pair("num", TableItem(1,100)));
	tran.insert(make_pair("load_mem", TableItem(1,101)));
	...
	// state 124
	tran.insert(make_pair("-", TableItem(1,124)));
	tran.insert(make_pair("expr", TableItem(3,222)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,224)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	tran.insert(make_pair(")", TableItem(2,64)));
	tran.insert(make_pair("rel", TableItem(3,240)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,249)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	// state 142
	tran.insert(make_pair("stmts", TableItem(3,253)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,202)));
	tran.insert(make_pair("param_list", TableItem(3,255)));
	tran.insert(make_pair("param", TableItem(3,204)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,257)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	tran.insert(make_pair("id", TableItem(1,175)));
	tran.insert(make_pair("num", TableItem(1,176)));
	tran.insert(make_pair("arg_list", TableItem(3,269)));
	tran.insert(make_pair("load_mem", TableItem(1,178)));
	...
	tran.insert(make_pair("/", TableItem(1,215)));
	tran.insert(make_pair("%", TableItem(1,216)));
	tran.insert(make_pair("]", TableItem(1,289)));
	...
	tran.insert(make_pair("id", TableItem(1,175)));
	tran.insert(make_pair("num", TableItem(1,176)));
	tran.insert(make_pair("arg_list", TableItem(3,303)));
	tran.insert(make_pair("load_mem", TableItem(1,178)));
	...
	// state 202
	tran.insert(make_pair("id", TableItem(1,307)));
	...
	tran.insert(make_pair("id", TableItem(1,175)));
	tran.insert(make_pair("num", TableItem(1,176)));
	tran.insert(make_pair("arg_list", TableItem(3,323)));
	tran.insert(make_pair("load_mem", TableItem(1,178)));
	...
	tran.insert(make_pair("(", TableItem(1,339)));
	tran.insert(make_pair("id", TableItem(1,340)));
	tran.insert(make_pair("num", TableItem(1,341)));
	tran.insert(make_pair("load_mem", TableItem(1,342)));
	...
	tran.insert(make_pair("load_mem", TableItem(2,67)));
	tran.insert(make_pair("true", TableItem(2,67)));
	tran.insert(make_pair("false", TableItem(2,67)));
	...
	tran.insert(make_pair("-", TableItem(2,67)));
	tran.insert(make_pair("!", TableItem(2,67)));
	tran.insert(make_pair("M", TableItem(3,349)));
	tran.insert(make_pair("(", TableItem(2,67)));
	tran.insert(make_pair("id", TableItem(2,67)));
	tran.insert(make_pair("num", TableItem(2,67)));
	tran.insert(make_pair("load_mem", TableItem(2,67)));
	...
	// state 248
	tran.insert(make_pair("M", TableItem(3,350)));
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair(";", TableItem(2,67)));
	tran.insert(make_pair("static", TableItem(2,67)));
	tran.insert(make_pair("return", TableItem(2,67)));
	...
	// state 256
	tran.insert(make_pair("M", TableItem(3,355)));
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair(";", TableItem(2,67)));
	tran.insert(make_pair("static", TableItem(2,67)));
	tran.insert(make_pair("return", TableItem(2,67)));
	...
	tran.insert(make_pair("/", TableItem(1,165)));
	tran.insert(make_pair("%", TableItem(1,166)));
	tran.insert(make_pair(")", TableItem(1,359)));
	...
	tran.insert(make_pair("id", TableItem(1,175)));
	tran.insert(make_pair("num", TableItem(1,176)));
	tran.insert(make_pair("arg_list", TableItem(3,371)));
	tran.insert(make_pair("load_mem", TableItem(1,178)));
	...
	tran.insert(make_pair("/", TableItem(1,165)));
	tran.insert(make_pair("%", TableItem(1,166)));
	tran.insert(make_pair(")", TableItem(1,378)));
	...
	// state 308
	tran.insert(make_pair("type_spec", TableItem(3,202)));
	tran.insert(make_pair("param", TableItem(3,380)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	tran.insert(make_pair("char", TableItem(1,22)));
	...
	tran.insert(make_pair("/", TableItem(1,165)));
	tran.insert(make_pair("%", TableItem(1,166)));
	tran.insert(make_pair(")", TableItem(1,343)));
	...
	// state 337
	tran.insert(make_pair("-", TableItem(1,337)));
	tran.insert(make_pair("expr", TableItem(3,385)));
	tran.insert(make_pair("(", TableItem(1,339)));
	tran.insert(make_pair("id", TableItem(1,340)));
	tran.insert(make_pair("num", TableItem(1,341)));
	tran.insert(make_pair("load_mem", TableItem(1,342)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,403)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,404)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	// state 350
	tran.insert(make_pair("stmt", TableItem(3,405)));
	tran.insert(make_pair("includestmt", TableItem(3,406)));
	tran.insert(make_pair("{", TableItem(1,407)));
	tran.insert(make_pair("fun_define", TableItem(3,408)));
	tran.insert(make_pair("if_stmt", TableItem(3,409)));
	tran.insert(make_pair("while_stmt", TableItem(3,410)));
	tran.insert(make_pair("var_decl", TableItem(3,411)));
	tran.insert(make_pair(";", TableItem(1,412)));
	tran.insert(make_pair("static", TableItem(1,413)));
	tran.insert(make_pair("expr_stmt", TableItem(3,414)));
	tran.insert(make_pair("return", TableItem(1,415)));
	tran.insert(make_pair("set_mem", TableItem(1,416)));
	tran.insert(make_pair("include", TableItem(1,417)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,418)));
	tran.insert(make_pair("type_spec", TableItem(3,419)));
	tran.insert(make_pair("id", TableItem(1,18)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("bool", TableItem(1,23)));
	tran.insert(make_pair("float", TableItem(1,24)));
	tran.insert(make_pair("if", TableItem(1,420)));
	tran.insert(make_pair("while", TableItem(1,421)));
	...
	// state 355
	tran.insert(make_pair("stmt", TableItem(3,424)));
	tran.insert(make_pair("includestmt", TableItem(3,425)));
	tran.insert(make_pair("{", TableItem(1,426)));
	tran.insert(make_pair("fun_define", TableItem(3,427)));
	tran.insert(make_pair("if_stmt", TableItem(3,428)));
	tran.insert(make_pair("while_stmt", TableItem(3,429)));
	tran.insert(make_pair("var_decl", TableItem(3,430)));
	tran.insert(make_pair(";", TableItem(1,431)));
	tran.insert(make_pair("static", TableItem(1,432)));
	tran.insert(make_pair("expr_stmt", TableItem(3,433)));
	tran.insert(make_pair("return", TableItem(1,434)));
	tran.insert(make_pair("set_mem", TableItem(1,435)));
	tran.insert(make_pair("include", TableItem(1,436)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,437)));
	tran.insert(make_pair("type_spec", TableItem(3,438)));
	tran.insert(make_pair("id", TableItem(1,18)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("bool", TableItem(1,23)));
	tran.insert(make_pair("float", TableItem(1,24)));
	tran.insert(make_pair("if", TableItem(1,439)));
	tran.insert(make_pair("while", TableItem(1,440)));
	...
	tran.insert(make_pair("/", TableItem(1,165)));
	tran.insert(make_pair("%", TableItem(1,166)));
	tran.insert(make_pair(")", TableItem(1,444)));
	...
	// state 379
	tran.insert(make_pair("num", TableItem(1,446)));
	...
	tran.insert(make_pair("expr", TableItem(3,467)));
	tran.insert(make_pair("(", TableItem(1,53)));
	tran.insert(make_pair("id", TableItem(1,54)));
	tran.insert(make_pair("num", TableItem(1,55)));
	tran.insert(make_pair("load_mem", TableItem(1,56)));
	...
	// state 418
	tran.insert(make_pair("{", TableItem(2,69)));
	tran.insert(make_pair("BlockLeader", TableItem(3,471)));
	_parseTable.insert(make_pair(418,tran));
	tran.clear();


	// state 419
	tran.insert(make_pair("id", TableItem(1,472)));
	...
	tran.insert(make_pair("float", TableItem(2,56)));
	tran.insert(make_pair("if", TableItem(2,56)));
	tran.insert(make_pair("N", TableItem(3,477)));
	tran.insert(make_pair("while", TableItem(2,56)));
	...
	// state 426
	tran.insert(make_pair("stmts", TableItem(3,478)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 432
	tran.insert(make_pair("var_decl", TableItem(3,480)));
	tran.insert(make_pair("type_spec", TableItem(3,48)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("expr", TableItem(3,483)));
	tran.insert(make_pair("(", TableItem(1,53)));
	tran.insert(make_pair("id", TableItem(1,54)));
	tran.insert(make_pair("num", TableItem(1,55)));
	tran.insert(make_pair("load_mem", TableItem(1,56)));
	...
	// state 438
	tran.insert(make_pair("id", TableItem(1,488)));
	...
	// state 440
	tran.insert(make_pair("M", TableItem(3,490)));
	tran.insert(make_pair("(", TableItem(2,67)));
	...
	// state 441
	tran.insert(make_pair("stmt", TableItem(3,491)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	tran.insert(make_pair("if_stmt", TableItem(3,33)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,505)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,516)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,526)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	tran.insert(make_pair("num", TableItem(1,129)));
	tran.insert(make_pair("load_mem", TableItem(1,130)));
	tran.insert(make_pair("logic_expr", TableItem(3,535)));
	tran.insert(make_pair("true", TableItem(1,132)));
	tran.insert(make_pair("false", TableItem(1,133)));
	...
	// state 525
	tran.insert(make_pair("M", TableItem(3,540)));
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair(";", TableItem(2,67)));
	tran.insert(make_pair("static", TableItem(2,67)));
	tran.insert(make_pair("return", TableItem(2,67)));
	...
	// state 540
	tran.insert(make_pair("stmt", TableItem(3,549)));
	tran.insert(make_pair("includestmt", TableItem(3,406)));
	tran.insert(make_pair("{", TableItem(1,407)));
	tran.insert(make_pair("fun_define", TableItem(3,408)));
	tran.insert(make_pair("if_stmt", TableItem(3,409)));
	...
	// state 541
	tran.insert(make_pair("M", TableItem(3,550)));
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair(";", TableItem(2,67)));
	tran.insert(make_pair("static", TableItem(2,67)));
	tran.insert(make_pair("return", TableItem(2,67)));
	...
	// state 547
	tran.insert(make_pair("M", TableItem(3,553)));
	tran.insert(make_pair("{", TableItem(2,67)));
	tran.insert(make_pair(";", TableItem(2,67)));
	tran.insert(make_pair("static", TableItem(2,67)));
	tran.insert(make_pair("return", TableItem(2,67)));
	...
	tran.insert(make_pair("float", TableItem(2,56)));
	tran.insert(make_pair("if", TableItem(2,56)));
	tran.insert(make_pair("N", TableItem(3,555)));
	tran.insert(make_pair("while", TableItem(2,56)));
	tran.insert(make_pair("$", TableItem(2,56)));
	...
	// state 550
	tran.insert(make_pair("stmt", TableItem(3,556)));
	tran.insert(make_pair("includestmt", TableItem(3,406)));
	tran.insert(make_pair("{", TableItem(1,407)));
	tran.insert(make_pair("fun_define", TableItem(3,408)));
	tran.insert(make_pair("if_stmt", TableItem(3,409)));
