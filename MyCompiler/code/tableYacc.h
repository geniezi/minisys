...
void initTable(map<unsigned int, map<string, TableItem> >& _parseTable) {
	...
	tran.insert(make_pair("{", TableItem(1,4)));
	tran.insert(make_pair("fun_define", TableItem(3,5)));
	tran.insert(make_pair("if_stmt", TableItem(3,6)));
	tran.insert(make_pair("while_stmt", TableItem(3,7)));
	tran.insert(make_pair("var_decl", TableItem(3,8)));
	tran.insert(make_pair("static", TableItem(3,9)));
	tran.insert(make_pair("expr_stmt", TableItem(3,10)));
	tran.insert(make_pair("return", TableItem(1,11)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,12)));
	tran.insert(make_pair("type_spec", TableItem(3,13)));
	tran.insert(make_pair("id", TableItem(1,14)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	tran.insert(make_pair("char", TableItem(1,18)));
	tran.insert(make_pair("bool", TableItem(1,19)));
	tran.insert(make_pair("float", TableItem(1,20)));
	tran.insert(make_pair("if", TableItem(1,21)));
	tran.insert(make_pair("while", TableItem(1,22)));
	...
	// state 2
	tran.insert(make_pair("M", TableItem(3,23)));
	...
	// state 4
	tran.insert(make_pair("stmts", TableItem(3,24)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	tran.insert(make_pair("while_stmt", TableItem(3,29)));
	tran.insert(make_pair("var_decl", TableItem(3,30)));
	tran.insert(make_pair("static", TableItem(3,31)));
	tran.insert(make_pair("expr_stmt", TableItem(3,32)));
	tran.insert(make_pair("return", TableItem(1,33)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,34)));
	tran.insert(make_pair("type_spec", TableItem(3,35)));
	tran.insert(make_pair("id", TableItem(1,14)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	tran.insert(make_pair("bool", TableItem(1,19)));
	tran.insert(make_pair("float", TableItem(1,20)));
	tran.insert(make_pair("if", TableItem(1,36)));
	tran.insert(make_pair("while", TableItem(1,37)));
	...
	// state 8
	tran.insert(make_pair(";", TableItem(1,38)));
	_parseTable.insert(make_pair(8,tran));
	tran.clear();


	// state 9
	tran.insert(make_pair("var_decl", TableItem(3,39)));
	tran.insert(make_pair("type_spec", TableItem(3,40)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	tran.insert(make_pair("char", TableItem(1,18)));
	...
	// state 10
	tran.insert(make_pair(";", TableItem(1,41)));
	...
	tran.insert(make_pair("expr", TableItem(3,43)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	tran.insert(make_pair("BlockLeader", TableItem(3,47)));
	...
	// state 15
	tran.insert(make_pair("id", TableItem(2,22)));
	_parseTable.insert(make_pair(15,tran));
	tran.clear();


	// state 16
	tran.insert(make_pair("id", TableItem(2,23)));
	_parseTable.insert(make_pair(16,tran));
	tran.clear();


	// state 17
	tran.insert(make_pair("id", TableItem(2,24)));
	...
	// state 21
	tran.insert(make_pair("BlockLeader", TableItem(3,50)));
	tran.insert(make_pair("(", TableItem(2,61)));
	...
	// state 22
	tran.insert(make_pair("{", TableItem(2,61)));
	tran.insert(make_pair("return", TableItem(2,61)));
	tran.insert(make_pair("BlockLeader", TableItem(3,51)));
	tran.insert(make_pair("id", TableItem(2,61)));
	tran.insert(make_pair("(", TableItem(2,61)));
	tran.insert(make_pair("int", TableItem(2,61)));
	tran.insert(make_pair("double", TableItem(2,61)));
	tran.insert(make_pair("void", TableItem(2,61)));
	tran.insert(make_pair("char", TableItem(2,61)));
	tran.insert(make_pair("bool", TableItem(2,61)));
	tran.insert(make_pair("float", TableItem(2,61)));
	tran.insert(make_pair("if", TableItem(2,61)));
	tran.insert(make_pair("while", TableItem(2,61)));
	tran.insert(make_pair("$", TableItem(2,61)));
	...
	// state 23
	tran.insert(make_pair("stmt", TableItem(3,52)));
	tran.insert(make_pair("{", TableItem(1,4)));
	tran.insert(make_pair("fun_define", TableItem(3,5)));
	tran.insert(make_pair("if_stmt", TableItem(3,6)));
	tran.insert(make_pair("while_stmt", TableItem(3,7)));
	...
	// state 24
	tran.insert(make_pair("M", TableItem(3,53)));
	tran.insert(make_pair("{", TableItem(2,59)));
	...
	// state 26
	tran.insert(make_pair("stmts", TableItem(3,55)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	// state 31
	tran.insert(make_pair("var_decl", TableItem(3,57)));
	tran.insert(make_pair("type_spec", TableItem(3,40)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	// state 33
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,59)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	// state 40
	tran.insert(make_pair("id", TableItem(1,65)));
	...
	// state 42
	tran.insert(make_pair("num", TableItem(1,66)));
	...
	tran.insert(make_pair("expr", TableItem(3,81)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	// state 51
	tran.insert(make_pair("M", TableItem(3,91)));
	tran.insert(make_pair("(", TableItem(2,59)));
	...
	// state 53
	tran.insert(make_pair("stmt", TableItem(3,92)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	tran.insert(make_pair("while_stmt", TableItem(3,29)));
	...
	// state 63
	tran.insert(make_pair("M", TableItem(3,99)));
	tran.insert(make_pair("(", TableItem(2,59)));
	...
	// state 68
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,101)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	// state 70
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,103)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	// state 72
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,105)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	// state 74
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,107)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	// state 75
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,108)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	// state 76
	tran.insert(make_pair("-", TableItem(1,42)));
	tran.insert(make_pair("expr", TableItem(3,109)));
	tran.insert(make_pair("id", TableItem(1,44)));
	tran.insert(make_pair("(", TableItem(1,45)));
	tran.insert(make_pair("num", TableItem(1,46)));
	...
	tran.insert(make_pair("id", TableItem(1,112)));
	tran.insert(make_pair("(", TableItem(1,113)));
	tran.insert(make_pair(")", TableItem(2,47)));
	tran.insert(make_pair(",", TableItem(2,47)));
	tran.insert(make_pair("arg_list", TableItem(3,114)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	tran.insert(make_pair("id", TableItem(1,118)));
	...
	// state 80
	tran.insert(make_pair("num", TableItem(1,121)));
	...
	// state 85
	tran.insert(make_pair("stmts", TableItem(3,136)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	// state 87
	tran.insert(make_pair("type_spec", TableItem(3,138)));
	tran.insert(make_pair(")", TableItem(1,139)));
	tran.insert(make_pair("param_list", TableItem(3,140)));
	tran.insert(make_pair("param", TableItem(3,141)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	tran.insert(make_pair("char", TableItem(1,18)));
	...
	// state 88
	tran.insert(make_pair("num", TableItem(3,142)));
	...
	tran.insert(make_pair("id", TableItem(1,146)));
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,149)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	// state 96
	tran.insert(make_pair("stmts", TableItem(3,153)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	tran.insert(make_pair("param_list", TableItem(3,155)));
	tran.insert(make_pair("param", TableItem(3,141)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	// state 105
	tran.insert(make_pair("|", TableItem(2,29)));
	tran.insert(make_pair("^", TableItem(2,29)));
	tran.insert(make_pair("&", TableItem(2,29)));
	tran.insert(make_pair("<<", TableItem(2,29)));
	tran.insert(make_pair(">>", TableItem(2,29)));
	...
	// state 106
	tran.insert(make_pair("|", TableItem(2,30)));
	tran.insert(make_pair("^", TableItem(2,30)));
	tran.insert(make_pair("&", TableItem(2,30)));
	tran.insert(make_pair("<<", TableItem(2,30)));
	tran.insert(make_pair(">>", TableItem(2,30)));
	...
	// state 119
	tran.insert(make_pair("-", TableItem(1,80)));
	tran.insert(make_pair("expr", TableItem(3,188)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	// state 123
	tran.insert(make_pair("-", TableItem(1,80)));
	tran.insert(make_pair("expr", TableItem(3,190)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	// state 125
	tran.insert(make_pair("-", TableItem(1,80)));
	tran.insert(make_pair("expr", TableItem(3,192)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	// state 127
	tran.insert(make_pair("-", TableItem(1,80)));
	tran.insert(make_pair("expr", TableItem(3,194)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	// state 129
	tran.insert(make_pair("-", TableItem(1,80)));
	tran.insert(make_pair("expr", TableItem(3,196)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	// state 130
	tran.insert(make_pair("-", TableItem(1,80)));
	tran.insert(make_pair("expr", TableItem(3,197)));
	tran.insert(make_pair("id", TableItem(1,82)));
	tran.insert(make_pair("(", TableItem(1,83)));
	tran.insert(make_pair("num", TableItem(1,84)));
	...
	tran.insert(make_pair(")", TableItem(2,47)));
	tran.insert(make_pair(",", TableItem(2,47)));
	tran.insert(make_pair("arg_list", TableItem(3,199)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	// state 138
	tran.insert(make_pair("id", TableItem(1,203)));
	...
	// state 143
	tran.insert(make_pair("num", TableItem(1,207)));
	...
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,208)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	tran.insert(make_pair(")", TableItem(2,56)));
	tran.insert(make_pair("rel", TableItem(3,224)));
	...
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,232)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,236)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	// state 168
	tran.insert(make_pair("-", TableItem(1,110)));
	tran.insert(make_pair("expr", TableItem(3,246)));
	tran.insert(make_pair("id", TableItem(1,112)));
	tran.insert(make_pair("(", TableItem(1,113)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	tran.insert(make_pair(")", TableItem(2,47)));
	tran.insert(make_pair(",", TableItem(2,47)));
	tran.insert(make_pair("arg_list", TableItem(3,247)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	// state 170
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,248)));
	tran.insert(make_pair("id", TableItem(1,118)));
	tran.insert(make_pair("(", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	...
	// state 173
	tran.insert(make_pair("-", TableItem(1,110)));
	tran.insert(make_pair("expr", TableItem(3,250)));
	tran.insert(make_pair("id", TableItem(1,112)));
	tran.insert(make_pair("(", TableItem(1,113)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	// state 175
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,251)));
	tran.insert(make_pair("id", TableItem(1,118)));
	tran.insert(make_pair("(", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	...
	// state 176
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,252)));
	tran.insert(make_pair("id", TableItem(1,118)));
	tran.insert(make_pair("(", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	...
	// state 178
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,254)));
	tran.insert(make_pair("id", TableItem(1,118)));
	tran.insert(make_pair("(", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	...
	tran.insert(make_pair(")", TableItem(2,47)));
	tran.insert(make_pair(",", TableItem(2,47)));
	tran.insert(make_pair("arg_list", TableItem(3,261)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	// state 205
	tran.insert(make_pair("type_spec", TableItem(3,138)));
	tran.insert(make_pair("param", TableItem(3,267)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	tran.insert(make_pair("char", TableItem(1,18)));
	...
	tran.insert(make_pair("id", TableItem(2,62)));
	tran.insert(make_pair("(", TableItem(2,62)));
	tran.insert(make_pair("num", TableItem(2,62)));
	...
	tran.insert(make_pair("id", TableItem(2,64)));
	tran.insert(make_pair("(", TableItem(2,64)));
	tran.insert(make_pair("num", TableItem(2,64)));
	...
	tran.insert(make_pair("id", TableItem(1,281)));
	tran.insert(make_pair("(", TableItem(1,282)));
	tran.insert(make_pair("num", TableItem(1,283)));
	...
	tran.insert(make_pair(")", TableItem(2,47)));
	tran.insert(make_pair(",", TableItem(2,47)));
	tran.insert(make_pair("arg_list", TableItem(3,284)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	tran.insert(make_pair("-", TableItem(2,59)));
	tran.insert(make_pair("!", TableItem(2,59)));
	tran.insert(make_pair("M", TableItem(3,288)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("(", TableItem(2,59)));
	tran.insert(make_pair("num", TableItem(2,59)));
	tran.insert(make_pair("true", TableItem(2,59)));
	tran.insert(make_pair("false", TableItem(2,59)));
	...
	tran.insert(make_pair("-", TableItem(2,59)));
	tran.insert(make_pair("!", TableItem(2,59)));
	tran.insert(make_pair("M", TableItem(3,289)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("(", TableItem(2,59)));
	tran.insert(make_pair("num", TableItem(2,59)));
	tran.insert(make_pair("true", TableItem(2,59)));
	...
	// state 231
	tran.insert(make_pair("M", TableItem(3,290)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 235
	tran.insert(make_pair("M", TableItem(3,292)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	tran.insert(make_pair("/", TableItem(1,183)));
	tran.insert(make_pair("%", TableItem(1,184)));
	tran.insert(make_pair("]", TableItem(1,295)));
	...
	// state 266
	tran.insert(make_pair("num", TableItem(3,298)));
	...
	// state 279
	tran.insert(make_pair("num", TableItem(1,300)));
	...
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,317)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	// state 290
	tran.insert(make_pair("stmt", TableItem(3,318)));
	tran.insert(make_pair("{", TableItem(1,319)));
	tran.insert(make_pair("fun_define", TableItem(3,320)));
	tran.insert(make_pair("if_stmt", TableItem(3,321)));
	tran.insert(make_pair("while_stmt", TableItem(3,322)));
	tran.insert(make_pair("var_decl", TableItem(3,323)));
	tran.insert(make_pair("static", TableItem(3,324)));
	tran.insert(make_pair("expr_stmt", TableItem(3,325)));
	tran.insert(make_pair("return", TableItem(1,326)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,327)));
	tran.insert(make_pair("type_spec", TableItem(3,328)));
	tran.insert(make_pair("id", TableItem(1,14)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	tran.insert(make_pair("bool", TableItem(1,19)));
	tran.insert(make_pair("float", TableItem(1,20)));
	tran.insert(make_pair("if", TableItem(1,329)));
	tran.insert(make_pair("while", TableItem(1,330)));
	_parseTable.insert(make_pair(290,tran));
	tran.clear();


	// state 291
	tran.insert(make_pair("M", TableItem(3,331)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 292
	tran.insert(make_pair("stmt", TableItem(3,332)));
	tran.insert(make_pair("{", TableItem(1,333)));
	tran.insert(make_pair("fun_define", TableItem(3,334)));
	tran.insert(make_pair("if_stmt", TableItem(3,335)));
	tran.insert(make_pair("while_stmt", TableItem(3,336)));
	tran.insert(make_pair("var_decl", TableItem(3,337)));
	tran.insert(make_pair("static", TableItem(3,338)));
	tran.insert(make_pair("expr_stmt", TableItem(3,339)));
	tran.insert(make_pair("return", TableItem(1,340)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,341)));
	tran.insert(make_pair("type_spec", TableItem(3,342)));
	tran.insert(make_pair("id", TableItem(1,14)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	tran.insert(make_pair("bool", TableItem(1,19)));
	tran.insert(make_pair("float", TableItem(1,20)));
	tran.insert(make_pair("if", TableItem(1,343)));
	tran.insert(make_pair("while", TableItem(1,344)));
	_parseTable.insert(make_pair(292,tran));
	tran.clear();


	// state 293
	tran.insert(make_pair("M", TableItem(3,345)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 298
	tran.insert(make_pair("]", TableItem(1,346)));
	...
	tran.insert(make_pair(")", TableItem(2,47)));
	tran.insert(make_pair(",", TableItem(2,47)));
	tran.insert(make_pair("arg_list", TableItem(3,357)));
	tran.insert(make_pair("num", TableItem(1,115)));
	...
	tran.insert(make_pair("return", TableItem(2,48)));
	tran.insert(make_pair("id", TableItem(2,48)));
	tran.insert(make_pair("int", TableItem(2,48)));
	tran.insert(make_pair("double", TableItem(2,48)));
	tran.insert(make_pair("void", TableItem(2,48)));
	tran.insert(make_pair("char", TableItem(2,48)));
	tran.insert(make_pair("bool", TableItem(2,48)));
	tran.insert(make_pair("float", TableItem(2,48)));
	tran.insert(make_pair("if", TableItem(2,48)));
	tran.insert(make_pair("N", TableItem(3,360)));
	tran.insert(make_pair("while", TableItem(2,48)));
	tran.insert(make_pair("$", TableItem(2,48)));
	...
	// state 319
	tran.insert(make_pair("stmts", TableItem(3,361)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	// state 324
	tran.insert(make_pair("var_decl", TableItem(3,363)));
	tran.insert(make_pair("type_spec", TableItem(3,40)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	// state 325
	tran.insert(make_pair(";", TableItem(1,364)));
	...
	// state 327
	tran.insert(make_pair("{", TableItem(2,61)));
	tran.insert(make_pair("BlockLeader", TableItem(3,366)));
	_parseTable.insert(make_pair(327,tran));
	tran.clear();


	// state 328
	tran.insert(make_pair("id", TableItem(1,367)));
	_parseTable.insert(make_pair(328,tran));
	tran.clear();


	// state 329
	tran.insert(make_pair("BlockLeader", TableItem(3,368)));
	tran.insert(make_pair("(", TableItem(2,61)));
	...
	// state 330
	tran.insert(make_pair("else", TableItem(2,61)));
	tran.insert(make_pair("{", TableItem(2,61)));
	tran.insert(make_pair("return", TableItem(2,61)));
	tran.insert(make_pair("BlockLeader", TableItem(3,369)));
	tran.insert(make_pair("id", TableItem(2,61)));
	tran.insert(make_pair("(", TableItem(2,61)));
	tran.insert(make_pair("int", TableItem(2,61)));
	tran.insert(make_pair("double", TableItem(2,61)));
	...
	// state 331
	tran.insert(make_pair("stmt", TableItem(3,370)));
	tran.insert(make_pair("{", TableItem(1,4)));
	tran.insert(make_pair("fun_define", TableItem(3,5)));
	tran.insert(make_pair("if_stmt", TableItem(3,6)));
	tran.insert(make_pair("while_stmt", TableItem(3,7)));
	...
	tran.insert(make_pair("float", TableItem(2,48)));
	tran.insert(make_pair("if", TableItem(2,48)));
	tran.insert(make_pair("N", TableItem(3,371)));
	tran.insert(make_pair("while", TableItem(2,48)));
	...
	// state 333
	tran.insert(make_pair("stmts", TableItem(3,372)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	// state 338
	tran.insert(make_pair("var_decl", TableItem(3,374)));
	tran.insert(make_pair("type_spec", TableItem(3,40)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	// state 341
	tran.insert(make_pair("{", TableItem(2,61)));
	tran.insert(make_pair("BlockLeader", TableItem(3,377)));
	_parseTable.insert(make_pair(341,tran));
	tran.clear();


	// state 342
	tran.insert(make_pair("id", TableItem(1,378)));
	_parseTable.insert(make_pair(342,tran));
	tran.clear();


	// state 343
	tran.insert(make_pair("BlockLeader", TableItem(3,379)));
	tran.insert(make_pair("(", TableItem(2,61)));
	...
	tran.insert(make_pair("}", TableItem(2,61)));
	tran.insert(make_pair("return", TableItem(2,61)));
	tran.insert(make_pair("BlockLeader", TableItem(3,380)));
	tran.insert(make_pair("id", TableItem(2,61)));
	tran.insert(make_pair("(", TableItem(2,61)));
	tran.insert(make_pair("int", TableItem(2,61)));
	tran.insert(make_pair("double", TableItem(2,61)));
	...
	// state 345
	tran.insert(make_pair("stmt", TableItem(3,381)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	tran.insert(make_pair("while_stmt", TableItem(3,29)));
	...
	// state 360
	tran.insert(make_pair("else", TableItem(1,384)));
	...
	// state 369
	tran.insert(make_pair("M", TableItem(3,391)));
	tran.insert(make_pair("(", TableItem(2,59)));
	...
	tran.insert(make_pair("return", TableItem(2,50)));
	tran.insert(make_pair("id", TableItem(2,50)));
	tran.insert(make_pair("int", TableItem(2,50)));
	tran.insert(make_pair("double", TableItem(2,50)));
	tran.insert(make_pair("void", TableItem(2,50)));
	tran.insert(make_pair("char", TableItem(2,50)));
	tran.insert(make_pair("bool", TableItem(2,50)));
	tran.insert(make_pair("float", TableItem(2,50)));
	tran.insert(make_pair("if", TableItem(2,50)));
	tran.insert(make_pair("while", TableItem(2,50)));
	tran.insert(make_pair("$", TableItem(2,50)));
	...
	// state 371
	tran.insert(make_pair("else", TableItem(1,392)));
	...
	// state 380
	tran.insert(make_pair("M", TableItem(3,399)));
	tran.insert(make_pair("(", TableItem(2,59)));
	...
	// state 384
	tran.insert(make_pair("M", TableItem(3,400)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 388
	tran.insert(make_pair("stmts", TableItem(3,401)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	tran.insert(make_pair("param_list", TableItem(3,403)));
	tran.insert(make_pair("param", TableItem(3,141)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	// state 392
	tran.insert(make_pair("M", TableItem(3,406)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 396
	tran.insert(make_pair("stmts", TableItem(3,407)));
	tran.insert(make_pair("stmt", TableItem(3,25)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	...
	tran.insert(make_pair("param_list", TableItem(3,409)));
	tran.insert(make_pair("param", TableItem(3,141)));
	tran.insert(make_pair("int", TableItem(1,15)));
	tran.insert(make_pair("double", TableItem(1,16)));
	tran.insert(make_pair("void", TableItem(1,17)));
	...
	// state 400
	tran.insert(make_pair("stmt", TableItem(3,412)));
	tran.insert(make_pair("{", TableItem(1,4)));
	tran.insert(make_pair("fun_define", TableItem(3,5)));
	tran.insert(make_pair("if_stmt", TableItem(3,6)));
	tran.insert(make_pair("while_stmt", TableItem(3,7)));
	...
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,416)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	// state 406
	tran.insert(make_pair("stmt", TableItem(3,417)));
	tran.insert(make_pair("{", TableItem(1,26)));
	tran.insert(make_pair("fun_define", TableItem(3,27)));
	tran.insert(make_pair("if_stmt", TableItem(3,28)));
	tran.insert(make_pair("while_stmt", TableItem(3,29)));
	...
	tran.insert(make_pair("(", TableItem(1,147)));
	tran.insert(make_pair("num", TableItem(1,148)));
	tran.insert(make_pair("logic_expr", TableItem(3,421)));
	tran.insert(make_pair("true", TableItem(1,150)));
	tran.insert(make_pair("false", TableItem(1,151)));
	...
	tran.insert(make_pair("return", TableItem(2,49)));
	tran.insert(make_pair("id", TableItem(2,49)));
	tran.insert(make_pair("int", TableItem(2,49)));
	tran.insert(make_pair("double", TableItem(2,49)));
	tran.insert(make_pair("void", TableItem(2,49)));
	tran.insert(make_pair("char", TableItem(2,49)));
	tran.insert(make_pair("bool", TableItem(2,49)));
	tran.insert(make_pair("float", TableItem(2,49)));
	tran.insert(make_pair("if", TableItem(2,49)));
	tran.insert(make_pair("while", TableItem(2,49)));
	tran.insert(make_pair("$", TableItem(2,49)));
	...
	// state 420
	tran.insert(make_pair("M", TableItem(3,424)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 422
	tran.insert(make_pair("stmt", TableItem(3,426)));
	tran.insert(make_pair("{", TableItem(1,319)));
	tran.insert(make_pair("fun_define", TableItem(3,320)));
	tran.insert(make_pair("if_stmt", TableItem(3,321)));
	tran.insert(make_pair("while_stmt", TableItem(3,322)));
	...
	// state 424
	tran.insert(make_pair("stmt", TableItem(3,428)));
	tran.insert(make_pair("{", TableItem(1,333)));
	tran.insert(make_pair("fun_define", TableItem(3,334)));
	tran.insert(make_pair("if_stmt", TableItem(3,335)));
	tran.insert(make_pair("while_stmt", TableItem(3,336)));
	...
	// state 425
	tran.insert(make_pair("M", TableItem(3,429)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 426
	tran.insert(make_pair("else", TableItem(2,48)));
	tran.insert(make_pair("{", TableItem(2,48)));
	tran.insert(make_pair("return", TableItem(2,48)));
	tran.insert(make_pair("id", TableItem(2,48)));
	tran.insert(make_pair("int", TableItem(2,48)));
	...
	tran.insert(make_pair("float", TableItem(2,48)));
	tran.insert(make_pair("if", TableItem(2,48)));
	tran.insert(make_pair("N", TableItem(3,430)));
	tran.insert(make_pair("while", TableItem(2,48)));
	tran.insert(make_pair("$", TableItem(2,48)));
	...
	// state 427
	tran.insert(make_pair("stmt", TableItem(3,431)));
	tran.insert(make_pair("{", TableItem(1,319)));
	tran.insert(make_pair("fun_define", TableItem(3,320)));
	tran.insert(make_pair("if_stmt", TableItem(3,321)));
	tran.insert(make_pair("while_stmt", TableItem(3,322)));
	...
	tran.insert(make_pair("float", TableItem(2,48)));
	tran.insert(make_pair("if", TableItem(2,48)));
	tran.insert(make_pair("N", TableItem(3,432)));
	tran.insert(make_pair("while", TableItem(2,48)));
	...
	// state 429
	tran.insert(make_pair("stmt", TableItem(3,433)));
	tran.insert(make_pair("{", TableItem(1,333)));
	tran.insert(make_pair("fun_define", TableItem(3,334)));
	tran.insert(make_pair("if_stmt", TableItem(3,335)));
	tran.insert(make_pair("while_stmt", TableItem(3,336)));
	...
	// state 430
	tran.insert(make_pair("else", TableItem(1,434)));
	_parseTable.insert(make_pair(430,tran));
	tran.clear();


	// state 431
	tran.insert(make_pair("else", TableItem(2,50)));
	tran.insert(make_pair("{", TableItem(2,50)));
	tran.insert(make_pair("return", TableItem(2,50)));
	tran.insert(make_pair("id", TableItem(2,50)));
	tran.insert(make_pair("int", TableItem(2,50)));
	...
	// state 432
	tran.insert(make_pair("else", TableItem(1,435)));
	...
	// state 434
	tran.insert(make_pair("M", TableItem(3,436)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 435
	tran.insert(make_pair("M", TableItem(3,437)));
	tran.insert(make_pair("{", TableItem(2,59)));
	tran.insert(make_pair("return", TableItem(2,59)));
	tran.insert(make_pair("id", TableItem(2,59)));
	tran.insert(make_pair("int", TableItem(2,59)));
	...
	// state 436
	tran.insert(make_pair("stmt", TableItem(3,438)));
	tran.insert(make_pair("{", TableItem(1,319)));
	tran.insert(make_pair("fun_define", TableItem(3,320)));
	tran.insert(make_pair("if_stmt", TableItem(3,321)));
	tran.insert(make_pair("while_stmt", TableItem(3,322)));
	...
	// state 437
	tran.insert(make_pair("stmt", TableItem(3,439)));
	tran.insert(make_pair("{", TableItem(1,333)));
	tran.insert(make_pair("fun_define", TableItem(3,334)));
	tran.insert(make_pair("if_stmt", TableItem(3,335)));
	tran.insert(make_pair("while_stmt", TableItem(3,336)));
	...
	// state 438
	tran.insert(make_pair("else", TableItem(2,49)));
	tran.insert(make_pair("{", TableItem(2,49)));
	tran.insert(make_pair("return", TableItem(2,49)));
	tran.insert(make_pair("id", TableItem(2,49)));
	tran.insert(make_pair("int", TableItem(2,49)));
