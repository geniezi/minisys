...
void initTable(map<unsigned int, map<string, TableItem> >& _parseTable) {
	...
	tran.insert(make_pair("set_mem", TableItem(1,14)));
	tran.insert(make_pair("include", TableItem(1,15)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,16)));
	tran.insert(make_pair("type_spec", TableItem(3,17)));
	tran.insert(make_pair("id", TableItem(1,18)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	tran.insert(make_pair("char", TableItem(1,22)));
	tran.insert(make_pair("bool", TableItem(1,23)));
	tran.insert(make_pair("float", TableItem(1,24)));
	tran.insert(make_pair("if", TableItem(1,25)));
	tran.insert(make_pair("while", TableItem(1,26)));
	...
	// state 2
	tran.insert(make_pair("M", TableItem(3,27)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	tran.insert(make_pair("set_mem", TableItem(2,66)));
	tran.insert(make_pair("include", TableItem(2,66)));
	tran.insert(make_pair("id", TableItem(2,66)));
	tran.insert(make_pair("int", TableItem(2,66)));
	tran.insert(make_pair("double", TableItem(2,66)));
	tran.insert(make_pair("void", TableItem(2,66)));
	tran.insert(make_pair("char", TableItem(2,66)));
	tran.insert(make_pair("bool", TableItem(2,66)));
	tran.insert(make_pair("float", TableItem(2,66)));
	tran.insert(make_pair("if", TableItem(2,66)));
	tran.insert(make_pair("while", TableItem(2,66)));
	...
	// state 5
	tran.insert(make_pair("stmts", TableItem(3,28)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	tran.insert(make_pair("if_stmt", TableItem(3,33)));
	tran.insert(make_pair("while_stmt", TableItem(3,34)));
	tran.insert(make_pair("var_decl", TableItem(3,35)));
	tran.insert(make_pair(";", TableItem(1,36)));
	tran.insert(make_pair("static", TableItem(1,37)));
	tran.insert(make_pair("expr_stmt", TableItem(3,38)));
	tran.insert(make_pair("return", TableItem(1,39)));
	tran.insert(make_pair("set_mem", TableItem(1,40)));
	tran.insert(make_pair("include", TableItem(1,41)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,42)));
	tran.insert(make_pair("type_spec", TableItem(3,43)));
	tran.insert(make_pair("id", TableItem(1,18)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("bool", TableItem(1,23)));
	tran.insert(make_pair("float", TableItem(1,24)));
	tran.insert(make_pair("if", TableItem(1,44)));
	tran.insert(make_pair("while", TableItem(1,45)));
	...
	// state 11
	tran.insert(make_pair("var_decl", TableItem(3,47)));
	tran.insert(make_pair("type_spec", TableItem(3,48)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	tran.insert(make_pair("char", TableItem(1,22)));
	...
	// state 13
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,51)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 15
	tran.insert(make_pair("<", TableItem(1,57)));
	tran.insert(make_pair("\"", TableItem(1,58)));
	...
	tran.insert(make_pair("BlockLeader", TableItem(3,59)));
	_parseTable.insert(make_pair(16,tran));
	tran.clear();


	// state 17
	tran.insert(make_pair("id", TableItem(1,60)));
	...
	tran.insert(make_pair("{", TableItem(2,68)));
	tran.insert(make_pair(";", TableItem(2,68)));
	tran.insert(make_pair("static", TableItem(2,68)));
	tran.insert(make_pair("return", TableItem(2,68)));
	tran.insert(make_pair("set_mem", TableItem(2,68)));
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("include", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,64)));
	tran.insert(make_pair("id", TableItem(2,68)));
	tran.insert(make_pair("int", TableItem(2,68)));
	tran.insert(make_pair("double", TableItem(2,68)));
	tran.insert(make_pair("void", TableItem(2,68)));
	tran.insert(make_pair("char", TableItem(2,68)));
	tran.insert(make_pair("bool", TableItem(2,68)));
	tran.insert(make_pair("float", TableItem(2,68)));
	tran.insert(make_pair("if", TableItem(2,68)));
	tran.insert(make_pair("while", TableItem(2,68)));
	tran.insert(make_pair("$", TableItem(2,68)));
	...
	// state 27
	tran.insert(make_pair("stmt", TableItem(3,65)));
	tran.insert(make_pair("includestmt", TableItem(3,4)));
	tran.insert(make_pair("{", TableItem(1,5)));
	tran.insert(make_pair("fun_define", TableItem(3,6)));
	tran.insert(make_pair("if_stmt", TableItem(3,7)));
	...
	// state 28
	tran.insert(make_pair("M", TableItem(3,66)));
	tran.insert(make_pair("{", TableItem(2,66)));
	...
	// state 31
	tran.insert(make_pair("stmts", TableItem(3,68)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 35
	tran.insert(make_pair(";", TableItem(1,69)));
	...
	// state 37
	tran.insert(make_pair("var_decl", TableItem(3,70)));
	tran.insert(make_pair("type_spec", TableItem(3,48)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	// state 38
	tran.insert(make_pair(";", TableItem(1,71)));
	...
	// state 39
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,72)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	tran.insert(make_pair("\"", TableItem(1,75)));
	...
	// state 42
	tran.insert(make_pair("{", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,76)));
	_parseTable.insert(make_pair(42,tran));
	tran.clear();


	// state 43
	tran.insert(make_pair("id", TableItem(1,77)));
	...
	// state 44
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,78)));
	...
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("include", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,79)));
	tran.insert(make_pair("id", TableItem(2,68)));
	tran.insert(make_pair("int", TableItem(2,68)));
	tran.insert(make_pair("double", TableItem(2,68)));
	tran.insert(make_pair("void", TableItem(2,68)));
	...
	// state 48
	tran.insert(make_pair("id", TableItem(1,81)));
	...
	// state 50
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,82)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	tran.insert(make_pair("expr", TableItem(3,95)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 55
	tran.insert(make_pair("(", TableItem(1,102)));
	...
	tran.insert(make_pair("expr", TableItem(3,104)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	_parseTable.insert(make_pair(56,tran));
	tran.clear();


	// state 57
	tran.insert(make_pair("filename", TableItem(1,109)));
	_parseTable.insert(make_pair(57,tran));
	tran.clear();


	// state 58
	tran.insert(make_pair("filename", TableItem(1,110)));
	...
	tran.insert(make_pair("(", TableItem(1,113)));
	...
	// state 61
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,115)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	tran.insert(make_pair("expr", TableItem(3,117)));
	tran.insert(make_pair("(", TableItem(1,118)));
	tran.insert(make_pair("id", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	tran.insert(make_pair("load_mem", TableItem(1,121)));
	_parseTable.insert(make_pair(62,tran));
	tran.clear();


	// state 63
	tran.insert(make_pair("(", TableItem(1,122)));
	_parseTable.insert(make_pair(63,tran));
	tran.clear();


	// state 64
	tran.insert(make_pair("M", TableItem(3,123)));
	tran.insert(make_pair("(", TableItem(2,66)));
	...
	// state 66
	tran.insert(make_pair("stmt", TableItem(3,124)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	tran.insert(make_pair("if_stmt", TableItem(3,33)));
	...
	// state 70
	tran.insert(make_pair(";", TableItem(1,126)));
	...
	tran.insert(make_pair("/", TableItem(1,91)));
	tran.insert(make_pair("%", TableItem(1,92)));
	tran.insert(make_pair(";", TableItem(1,127)));
	...
	// state 73
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,128)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 74
	tran.insert(make_pair("filename", TableItem(1,129)));
	_parseTable.insert(make_pair(74,tran));
	tran.clear();


	// state 75
	tran.insert(make_pair("filename", TableItem(1,130)));
	...
	// state 78
	tran.insert(make_pair("(", TableItem(1,133)));
	_parseTable.insert(make_pair(78,tran));
	tran.clear();


	// state 79
	tran.insert(make_pair("M", TableItem(3,134)));
	tran.insert(make_pair("(", TableItem(2,66)));
	...
	// state 84
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,136)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 85
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,137)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 87
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,139)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 88
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,140)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 89
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,141)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 90
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,142)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 91
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,143)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 92
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,144)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 94
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,145)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	tran.insert(make_pair("-", TableItem(1,152)));
	tran.insert(make_pair("*", TableItem(1,153)));
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,156)));
	...
	// state 96
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,157)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	tran.insert(make_pair("/", TableItem(2,46)));
	tran.insert(make_pair("%", TableItem(2,46)));
	tran.insert(make_pair("(", TableItem(1,158)));
	tran.insert(make_pair(")", TableItem(2,46)));
	tran.insert(make_pair("[", TableItem(1,159)));
	...
	tran.insert(make_pair(")", TableItem(2,54)));
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,166)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	// state 102
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,169)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 103
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,170)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	tran.insert(make_pair("%", TableItem(1,180)));
	...
	// state 105
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,182)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 109
	tran.insert(make_pair(">", TableItem(1,186)));
	...
	// state 111
	tran.insert(make_pair("stmts", TableItem(3,188)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 112
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,189)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,191)));
	tran.insert(make_pair("param_list", TableItem(3,192)));
	tran.insert(make_pair("param", TableItem(3,193)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	tran.insert(make_pair("char", TableItem(1,22)));
	...
	// state 114
	tran.insert(make_pair("num", TableItem(1,194)));
	...
	// state 116
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,195)));
	tran.insert(make_pair("(", TableItem(1,118)));
	tran.insert(make_pair("id", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	tran.insert(make_pair("load_mem", TableItem(1,121)));
	...
	// state 118
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,207)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	tran.insert(make_pair("/", TableItem(2,46)));
	tran.insert(make_pair("%", TableItem(2,46)));
	tran.insert(make_pair("(", TableItem(1,208)));
	tran.insert(make_pair("[", TableItem(1,209)));
	tran.insert(make_pair("]", TableItem(2,46)));
	...
	// state 121
	tran.insert(make_pair("(", TableItem(1,210)));
	_parseTable.insert(make_pair(121,tran));
	tran.clear();


	// state 122
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("!", TableItem(1,212)));
	tran.insert(make_pair("expr", TableItem(3,213)));
	tran.insert(make_pair("(", TableItem(1,214)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,218)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	// state 131
	tran.insert(make_pair("stmts", TableItem(3,225)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,191)));
	tran.insert(make_pair("param_list", TableItem(3,227)));
	tran.insert(make_pair("param", TableItem(3,193)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,228)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	// state 134
	tran.insert(make_pair("(", TableItem(1,229)));
	...
	// state 152
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,236)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 153
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,237)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 155
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,239)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,241)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	// state 159
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,242)));
	tran.insert(make_pair("(", TableItem(1,118)));
	tran.insert(make_pair("id", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	tran.insert(make_pair("load_mem", TableItem(1,121)));
	...
	// state 160
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,243)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 161
	tran.insert(make_pair("-", TableItem(1,161)));
	tran.insert(make_pair("expr", TableItem(3,244)));
	tran.insert(make_pair("(", TableItem(1,163)));
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	// state 163
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,255)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 171
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,263)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 172
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,264)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 174
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,266)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 175
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,267)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 176
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,268)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 177
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,269)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 178
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,270)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,275)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	// state 191
	tran.insert(make_pair("id", TableItem(1,279)));
	...
	tran.insert(make_pair(")", TableItem(1,281)));
	...
	// state 194
	tran.insert(make_pair("]", TableItem(1,282)));
	...
	// state 206
	tran.insert(make_pair("=", TableItem(1,293)));
	...
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,294)));
	...
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,295)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,300)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	tran.insert(make_pair("&&", TableItem(2,63)));
	tran.insert(make_pair("|", TableItem(1,301)));
	tran.insert(make_pair("^", TableItem(1,302)));
	tran.insert(make_pair("&", TableItem(1,303)));
	tran.insert(make_pair("==", TableItem(1,304)));
	tran.insert(make_pair("!=", TableItem(1,305)));
	tran.insert(make_pair("<", TableItem(1,306)));
	tran.insert(make_pair(">", TableItem(1,307)));
	tran.insert(make_pair("<=", TableItem(1,308)));
	tran.insert(make_pair("<<", TableItem(1,309)));
	tran.insert(make_pair(">>", TableItem(1,310)));
	tran.insert(make_pair("+", TableItem(1,311)));
	tran.insert(make_pair("-", TableItem(1,312)));
	tran.insert(make_pair("*", TableItem(1,313)));
	tran.insert(make_pair("/", TableItem(1,314)));
	tran.insert(make_pair("%", TableItem(1,315)));
	tran.insert(make_pair(")", TableItem(2,63)));
	tran.insert(make_pair("rel", TableItem(3,316)));
	...
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("!", TableItem(1,212)));
	tran.insert(make_pair("expr", TableItem(3,317)));
	tran.insert(make_pair("(", TableItem(1,214)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,318)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	tran.insert(make_pair(")", TableItem(2,46)));
	tran.insert(make_pair("[", TableItem(1,320)));
	...
	// state 217
	tran.insert(make_pair("(", TableItem(1,321)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,325)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,330)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,345)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	// state 257
	tran.insert(make_pair("-", TableItem(1,116)));
	tran.insert(make_pair("expr", TableItem(3,346)));
	tran.insert(make_pair("(", TableItem(1,118)));
	tran.insert(make_pair("id", TableItem(1,119)));
	tran.insert(make_pair("num", TableItem(1,120)));
	tran.insert(make_pair("load_mem", TableItem(1,121)));
	...
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,349)));
	...
	// state 275
	tran.insert(make_pair(",", TableItem(1,258)));
	tran.insert(make_pair(")", TableItem(1,350)));
	...
	tran.insert(make_pair("/", TableItem(1,204)));
	tran.insert(make_pair("%", TableItem(1,205)));
	tran.insert(make_pair("]", TableItem(1,351)));
	...
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,352)));
	...
	tran.insert(make_pair(")", TableItem(2,22)));
	tran.insert(make_pair("[", TableItem(1,353)));
	...
	// state 280
	tran.insert(make_pair("type_spec", TableItem(3,191)));
	tran.insert(make_pair("param", TableItem(3,354)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	tran.insert(make_pair("char", TableItem(1,22)));
	...
	// state 295
	tran.insert(make_pair(",", TableItem(1,258)));
	tran.insert(make_pair(")", TableItem(1,356)));
	...
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,358)));
	...
	// state 301
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,360)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 303
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,362)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	tran.insert(make_pair("load_mem", TableItem(2,70)));
	...
	tran.insert(make_pair("load_mem", TableItem(2,71)));
	...
	// state 309
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,363)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 310
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,364)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 311
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,365)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 312
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,366)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 313
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,367)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 314
	tran.insert(make_pair("-", TableItem(1,211)));
	tran.insert(make_pair("expr", TableItem(3,368)));
	tran.insert(make_pair("(", TableItem(1,299)));
	tran.insert(make_pair("id", TableItem(1,215)));
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	...
	// state 316
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,371)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,378)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	tran.insert(make_pair("-", TableItem(2,66)));
	tran.insert(make_pair("!", TableItem(2,66)));
	tran.insert(make_pair("M", TableItem(3,381)));
	tran.insert(make_pair("(", TableItem(2,66)));
	tran.insert(make_pair("id", TableItem(2,66)));
	tran.insert(make_pair("num", TableItem(2,66)));
	tran.insert(make_pair("load_mem", TableItem(2,66)));
	tran.insert(make_pair("true", TableItem(2,66)));
	tran.insert(make_pair("false", TableItem(2,66)));
	...
	tran.insert(make_pair("-", TableItem(2,66)));
	tran.insert(make_pair("!", TableItem(2,66)));
	tran.insert(make_pair("M", TableItem(3,382)));
	tran.insert(make_pair("(", TableItem(2,66)));
	tran.insert(make_pair("id", TableItem(2,66)));
	tran.insert(make_pair("num", TableItem(2,66)));
	tran.insert(make_pair("load_mem", TableItem(2,66)));
	...
	// state 324
	tran.insert(make_pair("M", TableItem(3,383)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 329
	tran.insert(make_pair("M", TableItem(3,386)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 345
	tran.insert(make_pair(",", TableItem(1,258)));
	tran.insert(make_pair(")", TableItem(1,388)));
	...
	// state 353
	tran.insert(make_pair("num", TableItem(1,392)));
	...
	// state 370
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,393)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	tran.insert(make_pair("&", TableItem(1,396)));
	...
	// state 372
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,404)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 375
	tran.insert(make_pair("(", TableItem(1,407)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,411)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,412)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	// state 383
	tran.insert(make_pair("stmt", TableItem(3,413)));
	tran.insert(make_pair("includestmt", TableItem(3,414)));
	tran.insert(make_pair("{", TableItem(1,415)));
	tran.insert(make_pair("fun_define", TableItem(3,416)));
	tran.insert(make_pair("if_stmt", TableItem(3,417)));
	tran.insert(make_pair("while_stmt", TableItem(3,418)));
	tran.insert(make_pair("var_decl", TableItem(3,419)));
	tran.insert(make_pair(";", TableItem(1,420)));
	tran.insert(make_pair("static", TableItem(1,421)));
	tran.insert(make_pair("expr_stmt", TableItem(3,422)));
	tran.insert(make_pair("return", TableItem(1,423)));
	tran.insert(make_pair("set_mem", TableItem(1,424)));
	tran.insert(make_pair("include", TableItem(1,425)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,426)));
	tran.insert(make_pair("type_spec", TableItem(3,427)));
	tran.insert(make_pair("id", TableItem(1,18)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("bool", TableItem(1,23)));
	tran.insert(make_pair("float", TableItem(1,24)));
	tran.insert(make_pair("if", TableItem(1,428)));
	tran.insert(make_pair("while", TableItem(1,429)));
	_parseTable.insert(make_pair(383,tran));
	tran.clear();


	// state 384
	tran.insert(make_pair("M", TableItem(3,430)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 386
	tran.insert(make_pair("stmt", TableItem(3,432)));
	tran.insert(make_pair("includestmt", TableItem(3,433)));
	tran.insert(make_pair("{", TableItem(1,434)));
	tran.insert(make_pair("fun_define", TableItem(3,435)));
	tran.insert(make_pair("if_stmt", TableItem(3,436)));
	tran.insert(make_pair("while_stmt", TableItem(3,437)));
	tran.insert(make_pair("var_decl", TableItem(3,438)));
	tran.insert(make_pair(";", TableItem(1,439)));
	tran.insert(make_pair("static", TableItem(1,440)));
	tran.insert(make_pair("expr_stmt", TableItem(3,441)));
	tran.insert(make_pair("return", TableItem(1,442)));
	tran.insert(make_pair("set_mem", TableItem(1,443)));
	tran.insert(make_pair("include", TableItem(1,444)));
	tran.insert(make_pair("fun_decl_head", TableItem(3,445)));
	tran.insert(make_pair("type_spec", TableItem(3,446)));
	tran.insert(make_pair("id", TableItem(1,18)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("bool", TableItem(1,23)));
	tran.insert(make_pair("float", TableItem(1,24)));
	tran.insert(make_pair("if", TableItem(1,447)));
	tran.insert(make_pair("while", TableItem(1,448)));
	_parseTable.insert(make_pair(386,tran));
	tran.clear();


	// state 387
	tran.insert(make_pair("M", TableItem(3,449)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 394
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,451)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	// state 395
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,452)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	// state 396
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,453)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	// state 397
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,454)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	// state 398
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,455)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	// state 399
	tran.insert(make_pair("-", TableItem(1,370)));
	tran.insert(make_pair("expr", TableItem(3,456)));
	tran.insert(make_pair("(", TableItem(1,372)));
	tran.insert(make_pair("id", TableItem(1,373)));
	tran.insert(make_pair("num", TableItem(1,374)));
	tran.insert(make_pair("load_mem", TableItem(1,375)));
	...
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,461)));
	...
	tran.insert(make_pair("id", TableItem(1,164)));
	tran.insert(make_pair("num", TableItem(1,165)));
	tran.insert(make_pair("arg_list", TableItem(3,462)));
	tran.insert(make_pair("load_mem", TableItem(1,167)));
	...
	// state 413
	tran.insert(make_pair("else", TableItem(2,67)));
	tran.insert(make_pair("{", TableItem(2,55)));
	tran.insert(make_pair(";", TableItem(2,55)));
	tran.insert(make_pair("static", TableItem(2,55)));
	tran.insert(make_pair("return", TableItem(2,55)));
	tran.insert(make_pair("set_mem", TableItem(2,55)));
	tran.insert(make_pair("include", TableItem(2,55)));
	tran.insert(make_pair("id", TableItem(2,55)));
	tran.insert(make_pair("int", TableItem(2,55)));
	tran.insert(make_pair("double", TableItem(2,55)));
	tran.insert(make_pair("void", TableItem(2,55)));
	tran.insert(make_pair("char", TableItem(2,55)));
	tran.insert(make_pair("bool", TableItem(2,55)));
	tran.insert(make_pair("float", TableItem(2,55)));
	tran.insert(make_pair("if", TableItem(2,55)));
	tran.insert(make_pair("N", TableItem(3,465)));
	tran.insert(make_pair("while", TableItem(2,55)));
	tran.insert(make_pair("$", TableItem(2,55)));
	...
	// state 415
	tran.insert(make_pair("stmts", TableItem(3,466)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 421
	tran.insert(make_pair("var_decl", TableItem(3,468)));
	tran.insert(make_pair("type_spec", TableItem(3,48)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	// state 422
	tran.insert(make_pair(";", TableItem(1,469)));
	...
	// state 424
	tran.insert(make_pair("(", TableItem(1,471)));
	_parseTable.insert(make_pair(424,tran));
	tran.clear();


	// state 425
	tran.insert(make_pair("<", TableItem(1,472)));
	...
	// state 426
	tran.insert(make_pair("{", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,474)));
	_parseTable.insert(make_pair(426,tran));
	tran.clear();


	// state 427
	tran.insert(make_pair("id", TableItem(1,475)));
	...
	// state 428
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,476)));
	_parseTable.insert(make_pair(428,tran));
	tran.clear();


	// state 429
	tran.insert(make_pair("else", TableItem(2,68)));
	tran.insert(make_pair("{", TableItem(2,68)));
	tran.insert(make_pair(";", TableItem(2,68)));
	tran.insert(make_pair("static", TableItem(2,68)));
	tran.insert(make_pair("return", TableItem(2,68)));
	...
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("include", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,477)));
	tran.insert(make_pair("id", TableItem(2,68)));
	tran.insert(make_pair("int", TableItem(2,68)));
	tran.insert(make_pair("double", TableItem(2,68)));
	tran.insert(make_pair("void", TableItem(2,68)));
	...
	// state 430
	tran.insert(make_pair("stmt", TableItem(3,478)));
	tran.insert(make_pair("includestmt", TableItem(3,4)));
	tran.insert(make_pair("{", TableItem(1,5)));
	tran.insert(make_pair("fun_define", TableItem(3,6)));
	tran.insert(make_pair("if_stmt", TableItem(3,7)));
	...
	tran.insert(make_pair("float", TableItem(2,55)));
	tran.insert(make_pair("if", TableItem(2,55)));
	tran.insert(make_pair("N", TableItem(3,479)));
	tran.insert(make_pair("while", TableItem(2,55)));
	...
	// state 434
	tran.insert(make_pair("stmts", TableItem(3,480)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 440
	tran.insert(make_pair("var_decl", TableItem(3,482)));
	tran.insert(make_pair("type_spec", TableItem(3,48)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	// state 441
	tran.insert(make_pair(";", TableItem(1,483)));
	...
	// state 442
	tran.insert(make_pair("-", TableItem(1,50)));
	tran.insert(make_pair("expr", TableItem(3,484)));
	tran.insert(make_pair("(", TableItem(1,52)));
	tran.insert(make_pair("id", TableItem(1,53)));
	tran.insert(make_pair("num", TableItem(1,54)));
	tran.insert(make_pair("load_mem", TableItem(1,55)));
	...
	// state 443
	tran.insert(make_pair("(", TableItem(1,485)));
	_parseTable.insert(make_pair(443,tran));
	tran.clear();


	// state 444
	tran.insert(make_pair("<", TableItem(1,486)));
	...
	// state 445
	tran.insert(make_pair("{", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,488)));
	_parseTable.insert(make_pair(445,tran));
	tran.clear();


	// state 446
	tran.insert(make_pair("id", TableItem(1,489)));
	...
	// state 447
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,490)));
	...
	tran.insert(make_pair("(", TableItem(2,68)));
	tran.insert(make_pair("include", TableItem(2,68)));
	tran.insert(make_pair("BlockLeader", TableItem(3,491)));
	tran.insert(make_pair("id", TableItem(2,68)));
	tran.insert(make_pair("int", TableItem(2,68)));
	tran.insert(make_pair("double", TableItem(2,68)));
	tran.insert(make_pair("void", TableItem(2,68)));
	...
	// state 449
	tran.insert(make_pair("stmt", TableItem(3,492)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	tran.insert(make_pair("if_stmt", TableItem(3,33)));
	...
	tran.insert(make_pair("/", TableItem(1,204)));
	tran.insert(make_pair("%", TableItem(1,205)));
	tran.insert(make_pair("]", TableItem(1,494)));
	...
	// state 465
	tran.insert(make_pair("else", TableItem(1,496)));
	...
	tran.insert(make_pair("/", TableItem(1,91)));
	tran.insert(make_pair("%", TableItem(1,92)));
	tran.insert(make_pair(";", TableItem(1,499)));
	...
	// state 471
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,500)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 472
	tran.insert(make_pair("filename", TableItem(1,501)));
	_parseTable.insert(make_pair(472,tran));
	tran.clear();


	// state 473
	tran.insert(make_pair("filename", TableItem(1,502)));
	_parseTable.insert(make_pair(473,tran));
	tran.clear();


	// state 474
	tran.insert(make_pair("{", TableItem(1,503)));
	...
	// state 477
	tran.insert(make_pair("M", TableItem(3,506)));
	tran.insert(make_pair("(", TableItem(2,66)));
	...
	tran.insert(make_pair(";", TableItem(2,57)));
	tran.insert(make_pair("static", TableItem(2,57)));
	tran.insert(make_pair("return", TableItem(2,57)));
	tran.insert(make_pair("set_mem", TableItem(2,57)));
	tran.insert(make_pair("include", TableItem(2,57)));
	tran.insert(make_pair("id", TableItem(2,57)));
	tran.insert(make_pair("int", TableItem(2,57)));
	tran.insert(make_pair("double", TableItem(2,57)));
	tran.insert(make_pair("void", TableItem(2,57)));
	tran.insert(make_pair("char", TableItem(2,57)));
	tran.insert(make_pair("bool", TableItem(2,57)));
	tran.insert(make_pair("float", TableItem(2,57)));
	tran.insert(make_pair("if", TableItem(2,57)));
	tran.insert(make_pair("while", TableItem(2,57)));
	tran.insert(make_pair("$", TableItem(2,57)));
	...
	// state 479
	tran.insert(make_pair("else", TableItem(1,507)));
	...
	tran.insert(make_pair("M", TableItem(3,66)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair("}", TableItem(1,508)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	tran.insert(make_pair("set_mem", TableItem(2,66)));
	...
	// state 485
	tran.insert(make_pair("-", TableItem(1,103)));
	tran.insert(make_pair("expr", TableItem(3,511)));
	tran.insert(make_pair("(", TableItem(1,105)));
	tran.insert(make_pair("id", TableItem(1,106)));
	tran.insert(make_pair("num", TableItem(1,107)));
	tran.insert(make_pair("load_mem", TableItem(1,108)));
	...
	// state 486
	tran.insert(make_pair("filename", TableItem(1,512)));
	...
	// state 488
	tran.insert(make_pair("{", TableItem(1,514)));
	...
	// state 491
	tran.insert(make_pair("M", TableItem(3,517)));
	tran.insert(make_pair("(", TableItem(2,66)));
	...
	// state 496
	tran.insert(make_pair("M", TableItem(3,518)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	tran.insert(make_pair("/", TableItem(1,179)));
	tran.insert(make_pair("%", TableItem(1,180)));
	tran.insert(make_pair(",", TableItem(1,519)));
	...
	// state 503
	tran.insert(make_pair("stmts", TableItem(3,522)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	// state 504
	tran.insert(make_pair(")", TableItem(1,523)));
	tran.insert(make_pair("type_spec", TableItem(3,191)));
	tran.insert(make_pair("param_list", TableItem(3,524)));
	tran.insert(make_pair("param", TableItem(3,193)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,525)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	// state 507
	tran.insert(make_pair("M", TableItem(3,527)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	tran.insert(make_pair("/", TableItem(1,179)));
	tran.insert(make_pair("%", TableItem(1,180)));
	tran.insert(make_pair(",", TableItem(1,528)));
	...
	// state 513
	tran.insert(make_pair("\"", TableItem(1,530)));
	_parseTable.insert(make_pair(513,tran));
	tran.clear();


	// state 514
	tran.insert(make_pair("stmts", TableItem(3,531)));
	tran.insert(make_pair("stmt", TableItem(3,29)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	...
	tran.insert(make_pair("type_spec", TableItem(3,191)));
	tran.insert(make_pair("param_list", TableItem(3,533)));
	tran.insert(make_pair("param", TableItem(3,193)));
	tran.insert(make_pair("int", TableItem(1,19)));
	tran.insert(make_pair("double", TableItem(1,20)));
	tran.insert(make_pair("void", TableItem(1,21)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,534)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	// state 518
	tran.insert(make_pair("stmt", TableItem(3,536)));
	tran.insert(make_pair("includestmt", TableItem(3,4)));
	tran.insert(make_pair("{", TableItem(1,5)));
	tran.insert(make_pair("fun_define", TableItem(3,6)));
	tran.insert(make_pair("if_stmt", TableItem(3,7)));
	...
	// state 519
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,537)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	tran.insert(make_pair("M", TableItem(3,66)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair("}", TableItem(1,538)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	tran.insert(make_pair("set_mem", TableItem(2,66)));
	...
	// state 524
	tran.insert(make_pair(",", TableItem(1,280)));
	tran.insert(make_pair(")", TableItem(1,539)));
	...
	tran.insert(make_pair("num", TableItem(1,216)));
	tran.insert(make_pair("load_mem", TableItem(1,217)));
	tran.insert(make_pair("logic_expr", TableItem(3,541)));
	tran.insert(make_pair("true", TableItem(1,219)));
	tran.insert(make_pair("false", TableItem(1,220)));
	...
	// state 527
	tran.insert(make_pair("stmt", TableItem(3,542)));
	tran.insert(make_pair("includestmt", TableItem(3,30)));
	tran.insert(make_pair("{", TableItem(1,31)));
	tran.insert(make_pair("fun_define", TableItem(3,32)));
	tran.insert(make_pair("if_stmt", TableItem(3,33)));
	...
	// state 528
	tran.insert(make_pair("-", TableItem(1,94)));
	tran.insert(make_pair("expr", TableItem(3,543)));
	tran.insert(make_pair("(", TableItem(1,96)));
	tran.insert(make_pair("id", TableItem(1,97)));
	tran.insert(make_pair("num", TableItem(1,98)));
	tran.insert(make_pair("load_mem", TableItem(1,99)));
	...
	// state 533
	tran.insert(make_pair(",", TableItem(1,280)));
	tran.insert(make_pair(")", TableItem(1,545)));
	...
	tran.insert(make_pair(";", TableItem(2,56)));
	tran.insert(make_pair("static", TableItem(2,56)));
	tran.insert(make_pair("return", TableItem(2,56)));
	tran.insert(make_pair("set_mem", TableItem(2,56)));
	tran.insert(make_pair("include", TableItem(2,56)));
	tran.insert(make_pair("id", TableItem(2,56)));
	tran.insert(make_pair("int", TableItem(2,56)));
	tran.insert(make_pair("double", TableItem(2,56)));
	tran.insert(make_pair("void", TableItem(2,56)));
	tran.insert(make_pair("char", TableItem(2,56)));
	tran.insert(make_pair("bool", TableItem(2,56)));
	tran.insert(make_pair("float", TableItem(2,56)));
	tran.insert(make_pair("if", TableItem(2,56)));
	tran.insert(make_pair("while", TableItem(2,56)));
	tran.insert(make_pair("$", TableItem(2,56)));
	...
	tran.insert(make_pair("/", TableItem(1,154)));
	tran.insert(make_pair("%", TableItem(1,155)));
	tran.insert(make_pair(")", TableItem(1,548)));
	...
	// state 540
	tran.insert(make_pair("M", TableItem(3,549)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 548
	tran.insert(make_pair(";", TableItem(1,554)));
	_parseTable.insert(make_pair(548,tran));
	tran.clear();


	// state 549
	tran.insert(make_pair("stmt", TableItem(3,555)));
	tran.insert(make_pair("includestmt", TableItem(3,414)));
	tran.insert(make_pair("{", TableItem(1,415)));
	tran.insert(make_pair("fun_define", TableItem(3,416)));
	tran.insert(make_pair("if_stmt", TableItem(3,417)));
	...
	// state 550
	tran.insert(make_pair("M", TableItem(3,556)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 552
	tran.insert(make_pair("stmt", TableItem(3,558)));
	tran.insert(make_pair("includestmt", TableItem(3,433)));
	tran.insert(make_pair("{", TableItem(1,434)));
	tran.insert(make_pair("fun_define", TableItem(3,435)));
	tran.insert(make_pair("if_stmt", TableItem(3,436)));
	...
	// state 553
	tran.insert(make_pair("M", TableItem(3,559)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 555
	tran.insert(make_pair("else", TableItem(2,55)));
	tran.insert(make_pair("{", TableItem(2,55)));
	tran.insert(make_pair(";", TableItem(2,55)));
	tran.insert(make_pair("static", TableItem(2,55)));
	tran.insert(make_pair("return", TableItem(2,55)));
	...
	tran.insert(make_pair("float", TableItem(2,55)));
	tran.insert(make_pair("if", TableItem(2,55)));
	tran.insert(make_pair("N", TableItem(3,560)));
	tran.insert(make_pair("while", TableItem(2,55)));
	tran.insert(make_pair("$", TableItem(2,55)));
	...
	tran.insert(make_pair("float", TableItem(2,55)));
	tran.insert(make_pair("if", TableItem(2,55)));
	tran.insert(make_pair("N", TableItem(3,562)));
	tran.insert(make_pair("while", TableItem(2,55)));
	...
	// state 559
	tran.insert(make_pair("stmt", TableItem(3,563)));
	tran.insert(make_pair("includestmt", TableItem(3,433)));
	tran.insert(make_pair("{", TableItem(1,434)));
	tran.insert(make_pair("fun_define", TableItem(3,435)));
	tran.insert(make_pair("if_stmt", TableItem(3,436)));
	...
	// state 560
	tran.insert(make_pair("else", TableItem(1,564)));
	_parseTable.insert(make_pair(560,tran));
	tran.clear();


	// state 561
	tran.insert(make_pair("else", TableItem(2,57)));
	tran.insert(make_pair("{", TableItem(2,57)));
	tran.insert(make_pair(";", TableItem(2,57)));
	tran.insert(make_pair("static", TableItem(2,57)));
	tran.insert(make_pair("return", TableItem(2,57)));
	...
	// state 562
	tran.insert(make_pair("else", TableItem(1,565)));
	...
	// state 564
	tran.insert(make_pair("M", TableItem(3,566)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 565
	tran.insert(make_pair("M", TableItem(3,567)));
	tran.insert(make_pair("{", TableItem(2,66)));
	tran.insert(make_pair(";", TableItem(2,66)));
	tran.insert(make_pair("static", TableItem(2,66)));
	tran.insert(make_pair("return", TableItem(2,66)));
	...
	// state 567
	tran.insert(make_pair("stmt", TableItem(3,569)));
	tran.insert(make_pair("includestmt", TableItem(3,433)));
	tran.insert(make_pair("{", TableItem(1,434)));
	tran.insert(make_pair("fun_define", TableItem(3,435)));
	tran.insert(make_pair("if_stmt", TableItem(3,436)));
	...
	// state 568
	tran.insert(make_pair("else", TableItem(2,56)));
	tran.insert(make_pair("{", TableItem(2,56)));
	tran.insert(make_pair(";", TableItem(2,56)));
	tran.insert(make_pair("static", TableItem(2,56)));
	tran.insert(make_pair("return", TableItem(2,56)));
